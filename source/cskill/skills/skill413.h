...
{ 
    ...
    { 
        static float aarray[10] = { 304,304,304,304,304,304,304,304,304,304 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
