...
/* 
10350  "Ослабление"10351  "^ffffffОслабление Уровень %d^ffcb4aДальность: ^ffffff6 м^ffcb4aЗатраты энергии: ^96f5ff115^ffffff^ffcb4aЗатраты физической силы: ^96f5ff500^ffffff^ffcb4aПрименение: ^ffffffмгновенное^ffcb4aПерезарядка: ^ffffff1^ffcb4a сек.^ffcb4aОграничения: ^ffffffнетПротивник теряет силы, так что едва может держать оружие.Его скорость атаки уменьшается на %d%% на 5 сек.^ffa083Влияние силы: каждые 2 очка снижают скорость атаки еще на 1%%.^72fe00Влияние ловкости: каждые 2 очка снижают скорость атаки еще на 1%%."*/ 
