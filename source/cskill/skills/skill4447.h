        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (3046);
                skill->SetRatio (0 + (skill->GetPlayer ()->GetRange () >= 40 ? 1.25 : 0));
