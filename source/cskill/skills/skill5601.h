...
/* 
56010  "Универсальное снятие состояний"56011  "Используется для снятия состояний задания.Максимальный уровень умения 9999Уровень умения заполняется в ID пакета состоянийдля снятия используется 572-icon2 4587 ур."*/ 
