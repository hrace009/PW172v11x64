...
/* 
35590  "Великий ночной танец"35591  "^ff5c00Великий ночной танец ^ffcb4aМаг. энергия: ^96f5ff545^ffffff^ffcb4aПодготовка: ^ffffff1,6 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff1,0 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff15,0 ^ffcb4aсек.^ffcb4aОграничение по оружию: ^ffffffмагическое оружие, без оружия^ffcb4aХарактеристика: ^ff5c00Мудрость^ffcb4aСтатус: ^ffffffМудрецЖрец входит в особое состояние, прячась в тенях. Это позволяет ему использовать особые навыки,но лишает возможности применять некоторые заклинания лечения и благословения.Прирост магической атаки от снаряжения в состоянии 'ночного танца' возрастает на ^96f5ff100%%^ffffff.^a6caf0Увеличивает максимальный запас ЖС в зависимости от уровня персонажа.^a6caf0После использования навыка восстанавливается ^96f5ff10%%^a6caf0 здоровья.^ffcb4aЭффект золотой руны:@1^ffcb4a1-4 ур.: дополнительно увеличивает маг. атаку на ^96f5ff20%%^ffcb4a от снаряжения^ffcb4a5-7 ур.: дополнительно увеличивает маг. атаку на ^96f5ff30%%^ffcb4a от снаряжения^ffcb4a8-9 ур.: дополнительно увеличивает маг. атаку на ^96f5ff40%%^ffcb4a от снаряжения^ffcb4a 10 ур.: дополнительно увеличивает маг. атаку на ^96f5ff50%%^ffcb4a от снаряжения@1@2Дополнительно увеличивает маг. атаку на ^96f5ff%d%%^ffcb4a от снаряжения@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (1.5 + (skill->GetT0 () - skill->GetT1 () * skill->GetT1 () - 50 * skill->GetT1 ()) * 0.00001);
