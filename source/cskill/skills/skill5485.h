    ...
    public: 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            {
			/*
				^00ff001-4 ��.: ��� ������������ ��������� ������������ ^96f5ff50%%^00ff00 ����� ������
				^00ff005-7 ��.: ��� ������������ ��������� ������������ ^96f5ff100%%^00ff00 ����� ������
				^00ff008-9 ��.: ��� ������������ ��������� ������������ ^96f5ff150%%^00ff00 ����� ������
				^00ff00 10 ��.: ��� ������������ ��������� ������������ ^96f5ff200%%^00ff00 ����� ������			
			...
			*/		
                ...
                skill->SetPlus (8343);
                skill->SetRatio (1.0 + (skill->GetPlayer()->GetRangetotarget () * ( aarray[skill->GetLevel () - 1] )));
