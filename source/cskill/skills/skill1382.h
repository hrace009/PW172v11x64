...
{ 
    ...
    { 
        static float aarray[10] = { 527,576,625,674,723,772,821,870,919,968 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
