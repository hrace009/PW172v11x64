...
/* 
64910  "Луч в небе"64911  "^ffffffЛуч в небе^ffcb4aМаг. энергия: ^96f5ff%.1f^ffffff^ffcb4aПодготовка: ^ffffffмгновенно^ffcb4aОграничение по оружию: ^ffffffбоевой шест^ffcb4aСтатус: ^ffffffСтойкий Используется после обращения в камень, после чего чары разрушаются.Оглушает противников в радиусе ^96f5ff8^ffffff м на ^96f5ff5^ffffff сек.^ffa4a9Для применения требуется состояние ^59EE4C'Каменное сердце'^ffa4a9."*/ 
