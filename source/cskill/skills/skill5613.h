...
/* 
56130  "–°–µ–≤–µ—Ä–Ω—ã–π –∫–æ–Ω—Ç–∏–Ω–µ–Ω—Ç - –∫—Ä–∏—Å—Ç–∞–ª–ª, –∫—Ä—É–≥ –Ω–∞–Ω–µ—Å–µ–Ω–∏—è —É—Ä–æ–Ω–∞ —Å –æ—Ç—Ç–∞–ª–∫–∏–≤–∞–Ω–∏–µ–º"56131  ""*/ 
...
{ 
    ...
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"±±¬Ω-ÀÆæß◊‘…Ì‘≤…À∫¶Õ∆»À"; 
        nativename          = "±±¬Ω-ÀÆæß◊‘…Ì‘≤…À∫¶Õ∆»À"; 
        icon                = ""; 
#endif 
        max_level           = 100; 
        type                = 3; 
