...
/* 
43110  "Ð­Ñ„Ñ„ÐµÐºÑ‚ Ð°ÑƒÑ€Ñ‹ Ð¼Ð³Ð½Ð¾Ð²ÐµÐ½Ð½Ð¾Ð³Ð¾ ÑƒÐ±Ð¸Ð¹ÑÑ‚Ð²Ð° ÑÑ„ÐµÑ€Ð¾Ð¹ Ð¤Ð¸Ð½Ð°Ð»ÑŒÐ½Ð¾Ð¹ Ð·Ð¾Ð½Ñ‹"43111  ""*/ 
...
{ 
    ...
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"×îÖÕÇø¹âÇòÃëÈË¹â»·Ð§¹û"; 
        nativename          = "×îÖÕÇø¹âÇòÃëÈË¹â»·Ð§¹û"; 
        icon                = ""; 
#endif 
        max_level           = 100; 
        type                = 3; 
