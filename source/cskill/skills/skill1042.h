...
/* 
10420  "Кража духа"10421  "^ffffffКража духа Уровень %d^ffcb4aДальность: ^ffffff15 м^ffcb4aЗатраты энергии: ^96f5ff%d^ffffff^ffcb4aЗатраты физической силы: ^96f5ff300^ffffff^ffcb4aПрименение: ^ffffffмгновенное^ffcb4aПерезарядка: ^ffffff1^ffcb4a сек.^ffcb4aОграничения: ^ffffffнетЗабирает у противника %d сотых ци и передает вам.Противник впадает в ярость и получает 0,3 ци каждые 3 сек. в течение 30 секунд.^72fe00Влияние ловкости: каждые 2 очка приносят дополнительно по 0,01 ци."*/ 
