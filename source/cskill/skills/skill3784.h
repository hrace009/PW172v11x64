...
/* 
37840  "Великие семь убийств"37841  "^ff5c00Великие семь убийств^ffcb4aДальность: ^ffffff4,5^ffffff ^ffcb4aм^ffcb4aМаг. энергия: ^96f5ff130^ffffff^ffcb4aПодготовка: ^ffffff0,1 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff2,5 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff15,0 ^ffcb4aсек.^ffcb4aПолучение ци: ^ffffff0,3^ffcb4aОграничение по оружию: ^ffffffкинжалы^ffcb4aХарактеристика: ^ff5c00Мощь^ffcb4aСтатус: ^ffffffАсураСекретная техника Лиги семи убийств.Обездвиживает противника на ^96f5ff3^ffffff сек. и наносит ^96f5ff320%%^ffffff базового физического урона и вызывает кровотечение,которое дополнительно наносит ^96f5ff750%%^ffffff урона оружия за ^96f5ff6^ffffff сек.^a6caf0Дает ^ffffff2^a6caf0 очка комбо.^00ffffЭффект сапфировой руны:@1^00ffff1-4 ур.: цель в течение ^ffffff6^00ffff сек. получает ^ffffff1050%%^00ffff урона оружия^00ffff5-7 ур.: цель в течение ^ffffff6^00ffff сек. получает ^ffffff1200%%^00ffff урона оружия^00ffff8-9 ур.: цель в течение ^ffffff6^00ffff сек. получает ^ffffff1350%%^00ffff урона оружия^00ffff 10 ур.: цель в течение ^ffffff6^00ffff сек. получает ^ffffff1500%%^00ffff урона оружия@1@2Цель в течение ^ffffff6^00ffff сек. получает ^ffffff%d%%^00ffff урона оружия от кровотечения.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
			float glyph = get_glyph((skill->GetLevel () - 1), 1050, 1200, 1350, 1500);
			skill->GetVictim ()->SetProbability (1.0 * (skill->GetSection () == 1 ? 100 : 0));
            skill->GetVictim ()->SetTime (4000);
            skill->GetVictim ()->SetFix (1);
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetSection () == 1 ? 100 : 0));
            skill->GetVictim ()->SetTime (6000);
            skill->GetVictim ()->SetAmount (2 * skill->GetT0 () + glyph);
