        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetGolddamage ((skill->GetPlayer ()->GetForm () == 1 ? 1.6 : 0.9) * skill->GetMagicattack ());
