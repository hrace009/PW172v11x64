...
/* 
62880  "Демонический призыв бога огня"62881  "^ffff00Демонический призыв бога огня^ffcb4aМаг. энергия: ^96f5ff1560^ffffff^ffcb4aПодготовка: ^ffffff1,5^ffcb4a сек.^ffcb4aПрименение: ^ffffff1,5^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff180 ^ffcb4aсек.^ffcb4aОграничение по оружию: ^ffffffмагическое оружие, без оружия^ffcb4aСтатус: ^ffffffДух злаНа ^96f5ff50^ffffff сек. призывает фантом бога огня, владеющего собственными умениями,который сражается на стороне мистика, нанося врагам огромный урон.^a6caf0Изучение умения 'Свет звезд' продлевает время существования фантома.^a6caf0'Перенос силы' не действует на фантома.^a6caf0Дополнительная стоимость: ^ffffff2^a6caf0 ци.^d618e7Расход МЭ снижается на ^96f5ff10%%^d618e7.^d618e7С вероятностью ^96f5ff25%%^d618e7 потратит только ^96f5ff1^d618e7 ци."*/ 
...
{ 
    ...
    { 
        static float aarray[10] = { 1560,1560,1560,1560,1560,1560,1560,1560,1560,1560 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        ...
        {
            skill->GetVictim ()->SetTime (52000);
            skill->GetVictim ()->SetRatio (10);
            skill->GetVictim ()->SetValue (68962);
