...
/* 
30630  "Цветок лотоса"30631  "Лоза: цель не может двигаться.Отравление: в течение 30 сек. цель получает урон от яда (каждые 2 сек. теряет примерно 5% здоровья).Восстановление здоровья: восстанавливается определенная доля здоровья (примерно 10%).Сопротивление Ярости лотоса: переступивший через цветок лотоса игрок приобретает иммунитет к его урону."*/ 
