...
{ 
    ...
    { 
        static float aarray[10] = { 164,172,180,189,197,205,213,221,229,237 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
