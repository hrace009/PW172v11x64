...
/* 
22690  "Зелье - Ускорение, увеличение урона, наносимого монстрам"22691  "Ускорение 1 ур.Увеличение урона, наносимого монстрам, 2 ур."*/ 
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
			...
			skill->GetVictim ()->SetProbability (1.0 * skill->GetLevel () == 3 ? 100 : 0); // 3 �ݧӧ� ��ާ֧ߧڧ� = 20% �ҧѧ�� PWREMASTERED
            skill->GetVictim ()->SetTime (3600000);
