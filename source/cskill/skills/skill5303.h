...
/* 
53030  "Погребальные песнопения"53031  "^ff0000Погребальные песнопения %d ур.^ffffffАктивируется после получения урона от обычной атаки.Поглощает ^96f5ff%d%%^ffffff урона от следующей обычной атаки.Перезарядка: ^96f5ff1^ffffff сек. Пассивный навык."*/ 
