    ...
    public: 
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            {
                skill->SetSection (1);
                skill->SetPlus (3.8*skill->GetPlayer ()->GetAttack ());
                skill->SetRatio (0);
