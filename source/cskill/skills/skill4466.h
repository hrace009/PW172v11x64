        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetSection (1);
                skill->SetPlus (13880);
                skill->SetRatio (skill->GetT0 () > 50 ? 4.5 : 5.5);
