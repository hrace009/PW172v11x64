...
/* 
59830  "Владыка севера [ускорение применения]"59831  "^ff0000Пустота: Песнь^ffcb4aПодготовка: ^ffffffмгновенно^ffcb4aПерезарядка: ^ffffff60,0 ^ffcb4aсек.^FFFFFFВ течение ^96f5ff20^FFFFFF сек. подготовка всех умений сокращается на ^96f5ff50%%^FFFFFF."*/ 
