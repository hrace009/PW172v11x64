...
/* 
41370  "Великий азарт"41371  "^ff5c00Великий азарт^ffcb4aДальность: ^96f5ff28^ffffff ^ffcb4aм ^ffcb4aМаг. энергия: ^96f5ff120^ffffff^ffcb4aПрименение: ^ffffff0,7 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff30,0 ^ffcb4aсек.^ffcb4aПолучение ци: ^ffffff0,1^ffcb4aОграничение по оружию: ^ffffffсабля^ffcb4aХарактеристика: ^ff5c00Храбрость^ffcb4aСтатус: ^ffffffМудрецПризрак набрасывается на противника, наносит ^96f5ff30%%^ffffff базового физ. уронаплюс ^96f5ff2148^ffffff ед. физ. урона и обездвиживает его на 2 сек.Если противник погибает в течение ^96f5ff20^ffffff сек., умение 'Азарт' мгновенно перезаряжается.^ffcb4aЭффект золотой руны:@1^ffcb4a1-4 ур.: добавляется ^96f5ff15%%^ffcb4a базовой силы атаки и ^96f5ff1200^ffcb4a ед. физ. урона^ffcb4a5-7 ур.: добавляется ^96f5ff20%%^ffcb4a базовой силы атаки и ^96f5ff1800^ffcb4a ед. физ. урона^ffcb4a8-9 ур.: добавляется ^96f5ff25%%^ffcb4a базовой силы атаки и ^96f5ff2400^ffcb4a ед. физ. урона^ffcb4a 10 ур.: добавляется ^96f5ff30%%^ffcb4a базовой силы атаки и ^96f5ff3000^ffcb4a ед. физ. урона@1@2Добавляется ^96f5ff%d%%^ffcb4a базовой силы атаки и ^96f5ff%d^ffcb4a ед. физ. урона.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (0.6 * skill->GetT0 () + 5148);
