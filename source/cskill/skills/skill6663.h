...
/* 
66630  "ÐžÑÐ½Ð¾Ð²Ð½Ð°Ñ Ð»Ð¸Ð½Ð¸Ñ Ð¦Ð°Ñ€Ñ Ð¾Ð±ÐµÐ·ÑŒÑÐ½ - Ð’Ð·Ñ€Ð¾ÑÐ»Ñ‹Ð¹ Ñ‡ÐµÐ»Ð¾Ð²ÐµÐº Ð±ÐµÐ· ÑƒÐ¼ÐµÐ½Ð¸Ð¹"66631  "Ð‘ÐµÐ· ÑƒÐ¼ÐµÐ½Ð¸Ð¹, 1 - Ð¾Ñ‚Ð¼ÐµÐ½Ð°, 2 - ÑÐ¼ÐµÐ½Ð° Ð¾Ð±Ð»Ð¸ÐºÐ°"*/ 
...
{ 
    ...
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÑýºïÖ÷Ïß-³ÉÄêÖ÷½ÇÎÞ¼¼ÄÜ"; 
        nativename          = "ÑýºïÖ÷Ïß-³ÉÄêÖ÷½ÇÎÞ¼¼ÄÜ"; 
        icon                = "¾÷Ñ©ºü±äÉí¿¨.dds"; 
#endif 
        max_level           = 1; 
        type                = 4; 
