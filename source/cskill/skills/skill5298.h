...
/* 
52980  "Заклинание здоровья"52981  "^ff0000Заклинание здоровья %d ур.^ffffffПри использовании умений восстанавливает здоровьев размере ^96f5ff%d%%^ffffff от потраченной магической энергии.Пассивный навык."*/ 
