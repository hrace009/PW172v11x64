...
/* 
52900  "Укрытая лазейка"52901  "^ff0000Укрытая лазейка %d ур.^ffffffВводит вас в состояние невидимости. Перезарядка: ^96f5ff%d^ffffff мин.Можно использовать только вне боя.Если вы будете двигаться или вступите в бой, то лишитесь невидимости."*/ 
