        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				// �� ����ާ� +20%
                skill->SetPlus (3580 * skill->GetPlayer ()->GetForm () == 1 ? 1.2 : 0);
                skill->SetRatio (1.2 * skill->GetPlayer ()->GetForm () == 1 ? 1.2 : 0);
