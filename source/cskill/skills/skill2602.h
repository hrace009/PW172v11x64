...
/* 
26020  "Иллюзии - Гнев небес"26021  "^ffffffИллюзии - Гнев небес^ffcb4aДальность: ^ffffff8 ^ffcb4aм^ffcb4aПодготовка: ^ffffff0,1 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff1,0 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff1,0 ^ffcb4aсек.^ffcb4aОграничение по оружию: ^ffffffсабляПризрак копирует навык воина и призывает образ пламенного дракона, который наносит противникам в радиусе ^96f5ff12^ffffff мбазовый физический урон плюс ^96f5ff80%%^ffffff урона оружия плюс ^96f5ff%.1f^ffffff ед. урона.Кроме того, на ^96f5ff6^ffffff сек. урон по противнику повышается на ^96f5ff75%%^ffffff.^a6caf0Дополнительная стоимость: ^ffffff1,5^a6caf0 ци"*/ 
