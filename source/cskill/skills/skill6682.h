...
/* 
66820  "ÐžÐ´Ð¸Ð½Ð¾Ñ‡Ð½Ñ‹Ð¹ ÑƒÑ€Ð¾Ð½ Ð¾Ñ‚ Ð±Ð¾ÐµÐ²Ð¾Ð¹ Ð±Ð°ÑˆÐ½Ð¸ Ð½Ð¾Ð²Ñ‹Ñ… Ð³Ð¾Ñ€Ð¾Ð´ÑÐºÐ¸Ñ… ÑÑ€Ð°Ð¶ÐµÐ½Ð¸Ð¹"66821  "8% Ð¼Ð°ÐºÑÐ¸Ð¼ÑƒÐ¼Ð° Ð·Ð´Ð¾Ñ€Ð¾Ð²ÑŒÑ"*/ 
...
{ 
    ...
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÐÂ³ÇÕ½ËþÂ¥µ¥ÌåÉËº¦"; 
        nativename          = "ÐÂ³ÇÕ½ËþÂ¥µ¥ÌåÉËº¦"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 3; 
        ...
        combosk_nobreak     = 0; 
#ifdef _SKILL_CLIENT 
        effect              = "2021_ÍêÃÀ¹ú¼Ê_¸ß¼¶¼ýËþ_À¶_ÆÕ¹¥»÷ÖÐ.att"; 
        aerial_effect       = ""; 
#endif 
        range.type          = 0; 
        has_stateattack     = 0; 
