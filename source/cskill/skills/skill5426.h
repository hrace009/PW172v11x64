...
{ 
    ...
    { 
        ...
        {
			/*
			^00ff001-4 ��.: ��������� ������������� �� ^96f5ff2^00ff00 �
			^00ff005-7 ��.: ��������� ������������� �� ^96f5ff3^00ff00 �
			^00ff008-9 ��.: ��������� ������������� �� ^96f5ff4^00ff00 �
			^00ff0010 ��.: ��������� ������������� �� ^96f5ff5^00ff00 
			*/
			static const int LEVEL_1_4 = 2;
			static const int LEVEL_5_7 = 3;
			static const int LEVEL_8_9 = 4;
			static const int LEVEL_10_10 = 5;
            ...
            return (float) (0 + ( aarray[skill->GetLevel () - 1] ));
        }
        ...
        float GetPraydistance (Skill * skill) const
        {
			...
			static const int LEVEL_10_10 = 5;
			static int aarray[10] = { LEVEL_1_4, LEVEL_1_4, LEVEL_1_4, LEVEL_1_4, LEVEL_5_7, LEVEL_5_7, LEVEL_5_7, LEVEL_8_9, LEVEL_8_9, LEVEL_10_10 };				
            return (float) (skill->GetPlayer ()->GetRange () + ( aarray[skill->GetLevel () - 1] ));
        }
