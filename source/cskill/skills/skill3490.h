...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    {
		/*
		^ff00001-4 ��.: ������� �������� ������������� �� ^96f5ff9^ff0000 �
		^ff00005-7 ��.: ������� �������� ������������� �� ^96f5ff10^ff0000 �
		^ff00008-9 ��.: ������� �������� ������������� �� ^96f5ff11^ff0000 �
		^ff0000 10 ��.: ������� �������� ������������� �� ^96f5ff12^ff0000 �		
		*/
		static int aarray[10] = { 9,9,9,9,10,10,10,11,11,12 }; 
        return aarray[skill->GetLevel () - 1]; 
    }
