...
/* 
66440  "Жетон генерала"66441  "^ffcb4aДальность: ^ffffff30^ffcb4a м^ffcb4aПерезарядка: ^ffffff10^ffcb4a сек.^ffffffС помощью Жетона генерала можно разозлить Бездушных, сделав их уязвимыми.^ff00ffБездушные скоро отступят!"*/ 
