...
/* 
18780  "Проклятье хаоса"18781  "^ffffffПроклятье хаоса ^a6caf0Умение призванного существа^ffcb4aДальность: ^ffffff10 ^ffcb4aм^ffcb4aПодготовка: ^ffffff1.0^ffcb4a сек.^ffcb4aПрименение: ^ffffff1.0^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff12.0^ffcb4a сек.^ffffffПротивники в радиусе ^a6caf05 м^ffffff от цели получают урон,равный ^96f5ff200%%^ffffff от базовой атаки стража, а шанс получения ими критического удара в течение ^96f5ff%d^ffffff сек.вырастает на ^96f5ff%d^ffffff. Этот показатель зависит от силы духа стража."*/ 
