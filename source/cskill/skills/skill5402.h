...
/* 
54020  "Таинственный щит мороза"54021  "^ffff00Таинственный щит мороза^ffcb4aМаг. энергия: ^96f5ffрасходуется полностью^ffcb4aПодготовка: ^ffffffмгновенно^ffcb4aПерезарядка: ^ffffff120^ffcb4a сек.Ограничение по оружию: ^ffffffмагическое оружие, без оружия^ffcb4aСтатус: ^ffffffБлагочестивыйРасходует всю имеющуюся магическую энергию на создание ледяного щита.Сила льда дает неуязвимость на ^96f5ff5^ffffff сек. и полностью восстанавливает здоровье, но не позволяет двигаться или атаковать.Кроме того, она накладывает щит на ^96f5ff10^ffffff сек., поглощающий урон, не превышающий размер магической энергии мага.После исчезновения щита ледяная волна замораживает всех противников-игроковв радиусе ^96f5ff12^ffffff м на ^96f5ff5^ffffff сек. Замороженные противники более уязвимы и получают ^96f5ff130%%^ffffff урона.Эффект заморозки может сочетаться с оглушением и заклинанием 'Ледяное дыхание'.^808080Эффект заморозки не действует против монстров."*/ 
    ...
    public: 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (skill->GetPlayer ()->GetMp () / 2);
