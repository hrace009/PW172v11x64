        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				/*
				^ffcb4a1-4 ��.: ����������� ^96f5ff48%%^ffcb4a ����� ������
				^ffcb4a5-7 ��.: ����������� ^96f5ff72%%^ffcb4a ����� ������
				^ffcb4a8-9 ��.: ����������� ^96f5ff96%%^ffcb4a ����� ������
				^ffcb4a 10 ��.: ����������� ^96f5ff120%%^ffcb4a ����� ������
				*/
                ...
                skill->SetRatio (3.0 + ( aarray[skill->GetLevel () - 1] ));
