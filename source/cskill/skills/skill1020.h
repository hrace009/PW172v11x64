...
/* 
10200  "Пыл земли"10201  "^ffffffПыл земли Уровень %d^ffcb4aДальность: ^ffffff15 м^ffcb4aЗатраты энергии: ^96f5ff%d^ffffff^ffcb4aЗатраты физической силы: ^96f5ff120^ffffff^ffcb4aПрименение: ^ffffffмгновенное^ffcb4aПерезарядка: ^ffffff1^ffcb4a сек.^ffcb4aОграничения: ^ffffffоборотеньУвеличивает прирост ци всех союзников в радиусе %d м.В течение 5 сек. при каждой атаке они дополнительно получают 0,03 ци.^ffa083Влияние силы: каждые 4 очка увеличивают время действия на 1 сек.^72fe00Влияние ловкости: каждые 70 очков увеличивают получаемую при атаке ци на 0,01 ед.^ff0000Используется только на земле."*/ 
