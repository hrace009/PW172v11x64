...
{ 
    ...
    { 
        static float aarray[10] = { 122,122,122,122,122,122,122,122,122,122 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
