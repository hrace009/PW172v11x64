...
/* 
33990  "Великие весенние напевы"33991  "^ff5c00Великие весенние напевы^ffcb4aДальность: ^96f5ff27^ffffff ^ffcb4aм^ffcb4aМаг. энергия: ^96f5ff192^ffffff^ffcb4aПодготовка: ^ffffff1,2^ffcb4a сек.^ffcb4aПрименение: ^ffffff0,8^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff1,0 ^ffcb4aсек.^ffcb4aПолучение ци: ^ffffff0,15^ffcb4aОграничение по оружию: ^ffffffкоса, без оружия^ffcb4aХарактеристика: ^ff5c00Храбрость^ffcb4aСтатус: ^ffffffАсураСтремительные взмахи косой наносят противнику урон, равный ^96f5ff90%%^ffffff базового маг. урона,плюс ^96f5ff120%%^ffffff урона оружия, плюс ^96f5ff4454^ffffff ед. урона стихией металла.Дается сфера грома.^96f5ffПосле трансформации наносимый урон повышается на ^ffffff33%%^ffa4a9Можно применять в движении^00ffffЭффект сапфировой руны:@1^ffffff1 сфера грома и 2 ледяные сферы^00ffff наносят дополнительный урон.^00ffff1-4 ур.: добавляется ^ffffff80%%^00ffff урона оружия и ^ffffff1360^00ffff ед. урона^00ffff5-7 ур.: добавляется ^ffffff120%%^00ffff урона оружия и ^ffffff2040^00ffff ед. урона^00ffff8-9 ур.: добавляется ^ffffff160%%^00ffff урона оружия и ^ffffff2720^00ffff ед. урона^00ffff 10 ур.: добавляется ^ffffff200%%^00ffff урона оружия и ^ffffff3400^00ffff ед. урона@1@2^ffffff1 сфера грома и 2 ледяные сферы^00ffff наносят дополнительно ^ffffff%d%%^00ffff урона оружияплюс ^ffffff%d^00ffff ед. урона.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (4454);
                skill->SetRatio (1.2 + skill->GetPlayer()->GetBalls() == 7 ? 2 : 0);
    ...
    { 
        static float aarray[10] = { 192,192,192,192,192,192,192,192,192,192 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
