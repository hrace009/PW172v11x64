        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (0);
                skill->SetRatio (0);
                skill->SetDamage (0.44 * skill->GetAttack ());
