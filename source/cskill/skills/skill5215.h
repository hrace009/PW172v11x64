...
/* 
52150  "Великий рассекающий взмах"52151  "^ff5c00Великий рассекающий взмах^ffcb4aДальность: ^ffffff20^ffcb4a м^ffcb4aМаг. энергия: ^96f5ff165,6^ffcb4aПодготовка: ^ffffff0,1^ffcb4a сек.^ffcb4aПрименение: ^ffffff1,0^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff40^ffcb4a сек.^ffcb4aПолучение ци: ^ffffff0,1^ffcb4aОграничение по оружию: ^ffffffмеч и щит^ffcb4aХарактеристика: ^ff5c00Мудрость^ffcb4aСтатус: ^ffffffМудрецРезкий удар мечом снизу вверх наносит противникам перед паладином базовый физический урон,плюс ^96f5ff100%%^ffffff урона оружия, плюс ^96f5ff7722^ffffff ед. физического урона.В течение следующих ^96f5ff5^ffffff сек. при нанесении обычной атаки или применении умения телепортирует к цели.Эффект не срабатывает, если паладин уже находится в статусе 'Разбитые мечты'.^00ff00Эффект изумрудной руны:@1^00ff001-4 ур.: время перезарядки сокращается до ^96f5ff35^00ff00 сек.^00ff005-7 ур.: время перезарядки сокращается до ^96f5ff30^00ff00 сек.^00ff008-9 ур.: время перезарядки сокращается до ^96f5ff25^00ff00 сек. ^00ff0010 ур.: время перезарядки сокращается до ^96f5ff20^00ff00 сек.@1@2Время перезарядки сокращается до ^96f5ff%d,0^00ff00 сек.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                static const float LEVEL_1_4 = 0.32;
				static const float LEVEL_5_7 = 0.64;
				static const float LEVEL_8_9 = 0.96;
				static const float LEVEL_10_10 = 1.28;
