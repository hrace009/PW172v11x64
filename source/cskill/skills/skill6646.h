...
/* 
66460  "Кузнецы славы"66461  "^ffffffКузнецы славы^ffffffМастерский прием боя с шестом сметает все вокруг,нанося противникам  в радиусе ^96f5ff12^ffffff м средний урон."*/ 
