...
/* 
47660  "Аура паркура Сюн Цзюня"47661  "Использование умения 4766В localvar0 заполняется x, обозначающий точку проверки под номером xЕсли наложено x-1 бонусов buff1, выполняется +1Если наложено 5 ур. бонуса buff1, все уровни снимаются, накладывается buff2"*/ 
