...
/* 
43260  "Техника одиночной печати"43261  "level==1, замедление 99%;level==2, потеря здоровья при движении;level==3, кража маны;Случайный статус, набор случайных и неодинаковых статусов"*/ 
