          ...
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				*/
                ...
                skill->SetRatio (1.0 + ( aarray[skill->GetLevel () - 1] ) * skill->GetCharging () / 1500);
