...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {			
			/*
			^00ff001-4 ���.: ��ҧ֧٧էӧڧاڧӧѧ֧� �����ڧӧߧڧܧ�� �ߧ� ^96f5ff1^00ff00 ��֧�.
			^00ff005-7 ���.: ��ҧ֧٧էӧڧاڧӧѧ֧� �����ڧӧߧڧܧ�� �ߧ� ^96f5ff1,5^00ff00 ��֧�.
			^00ff008-9 ���.: ��ҧ֧٧էӧڧاڧӧѧ֧� �����ڧӧߧڧܧ�� �ߧ� ^96f5ff2^00ff00 ��֧�.
			^00ff00 10 ���.: ��ҧ֧٧էӧڧاڧӧѧ֧� �����ڧӧߧڧܧ�� �ߧ� ^96f5ff2,5^00ff00 ��֧�
			*/
			static const int LEVEL_1_4 = 1000;
			static const int LEVEL_5_7 = 1500;
			static const int LEVEL_8_9 = 2000;
			static const int LEVEL_10_10 = 2500;
