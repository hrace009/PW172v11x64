...
bool BlessMe (Skill * skill) const
        {            
          float v = 0;
			v = skill->GetSection () == 4 ? 25 : v;
			v = skill->GetT0 () == 1 ? 100 : v;
			skill->GetVictim ()->SetProbability (1.0 * v);
            skill->GetVictim ()->SetValue (skill->GetMagicattack () * 0.12 + 1303);
