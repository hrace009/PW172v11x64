...
/* 
24810  "Воплощение снижает запас жизненных сил, выбрать нельзя."24811  "^ffffffПерегруз Ур.: %d^ffcb4aПодготовка: ^ffffff0.1^ffcb4a сек.^ffcb4aПрименение: ^ffffff0.1^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff10^ffcb4a сек.^ffffffС вероятностью ^96f5ff30%%^ffffffувеличивает интервалы между атаками врага на ^96f5ff%d%%^ffffff на ^96f5ff4^ffffff сек.На монстров действует слабее."*/ 
