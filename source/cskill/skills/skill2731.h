...
/* 
27310  "Темный филин"27311  "^8080ffТемный филин ^ffcb4aДальность: ^ffffffближний бой ^ffcb4aМаг. энергия: ^96f5ff93^ffffff^ffcb4aПодготовка: ^ffffff0,1 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff1,0 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff6,0 ^ffcb4aсек.^ffcb4aПолучение ци: ^ffffff0,1^ffcb4aОграничение по оружию: ^ffffffсабля^ffcb4aСтатус: ^ffffffДемонНаносит противнику базовый физ. уронплюс ^96f5ff3846^ffffff ед. физ. урона. Скорость перемещения персонажа возрастает на^96f5ff60%%^ffffff на ^96f5ff3^ffffff сек. В течение ^96f5ff6^ffffff сек. урон от следующего применения навыка 'Поражение'возрастает на ^96f5ff35%%^ffffff.^96f5ffПосле трансформации время перезарядки уменьшается до ^ffffff1^96f5ff сек.^d618e7При следующем применении умения 'Поражение' урон возрастает на ^96f5ff45%%^d618e7."*/ 
...
{ 
    ...
    { 
        static float aarray[10] = { 93,93,93,93,93,93,93,93,93,93 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
