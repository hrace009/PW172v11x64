...
/* 
23070  "Буря стрел"23071  "^8080ffБуря стрел^ffcb4aДальность: ^ffffffдальняя атака^ffcb4aМаг. энергия: ^96f5ff%d^ffffff^ffcb4aПодготовка: ^ffffff1,5^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff30,0 ^ffcb4aсек.^ffcb4aОграничение по оружию: ^ffffffоружие дальнего боя^ffcb4aСтатус: ^ffffffнетЛучник выпускает тучи стрел, затрачивая каждые ^96f5ff3^ffffff сек. по ^96f5ff1^ffffff ед. МЭ.Они наносят всем противникам в радиусе ^96f5ff12^ffffff м от цели базовый физический урон плюс ^96f5ff200%%^ffffff урона оружия.Лучник стреляет, пока не закончится МЭ или пока игрок не нажмет клавишу 'Esc'.^a6caf0На каждый выстрел нужно ^ffffff3^a6caf0 стрелы или дротика."*/ 
