...
/* 
29730  "Призыв Священного света"29731  "^ffff00Священный свет из Священной жемчужины используется для выбора и усиления Стражей реликвий. Всего Стражей реликвий можно усиливать ^96f5ff3 раза^ffff00, при этом между попытками усиления должно пройти некоторое время.Страж Макура проводит мощную атаку по области и замедляет врагов.Стражница Антар проводит атаку по одиночной цели и увеличивает наносимый урон."*/ 
