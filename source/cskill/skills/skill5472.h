    ...
    public: 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
				/*
				^00ffff1-4 ���.: �ӧ�֧ާ� ���էԧ���ӧܧ� ���ܧ�ѧ�ѧ֧��� �է� ^ffffff1,4^00ffff ��֧�.
				^00ffff5-7 ���.: �ӧ�֧ާ� ���էԧ���ӧܧ� ���ܧ�ѧ�ѧ֧��� �է� ^ffffff1,2^00ffff ��֧�.
				^00ffff8-9 ���.: �ӧ�֧ާ� ���էԧ���ӧܧ� ���ܧ�ѧ�ѧ֧��� �է� ^ffffff1,0^00ffff ��֧�.
				^00ffff10 ���.: �ӧ�֧ާ� ���էԧ���ӧܧ� ���ܧ�ѧ�ѧ֧��� �է� ^ffffff0,8^00ffff ��֧�.
				*/
