...
/* 
65650  "Основная линия Царя обезьян - Молодой человек"65651  "Уровень умений 1 - трансформация и отсутствие умений, 2 - трансформация, наличие умений, 3 - отмена трансформации"*/ 
