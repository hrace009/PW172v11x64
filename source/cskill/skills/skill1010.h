...
/* 
10100  "Клинок света"10101  "^ffffffКлинок света Уровень %d^ffcb4aДальность: ^ffffff30 м^ffcb4aЗатраты энергии: ^96f5ffВся^ffffff^ffcb4aЗатраты физической силы: ^96f5ff500^ffffff^ffcb4aПрименение: ^ffffffмгновенное^ffcb4aПерезарядка: ^ffffff1^ffcb4a сек.^ffcb4aОграничения: ^ffffffнетДжинн расходует всю имеющуюся энергию, чтобы создать небесный меч и поразить им противника.Наносит %.1f ед. физического урона за каждые 100 ед. энергии. Не промахивается.^ffa083Влияние силы: каждое очко увеличивает урон на 1 ед."*/ 
