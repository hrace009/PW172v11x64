          ...
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				*/
				...
				static const float LEVEL_5_7 = 0.75;
				static const float LEVEL_8_9 = 1.00;
				static const float LEVEL_10_10 = 1.25;
				...
				skill->GetPlayer ()->SetDecmp (268); // забирает ману
                skill->SetPlus (7588); // статический урон
                skill->SetRatio (1.5 + aarray[skill->GetLevel () - 1]); // урон от оружия
                skill->SetGolddamage (skill->GetAttack ()); // вставляется урон от огня
                skill->GetPlayer ()->SetPerform (1);
