...
/* 
59810  "Владыка севера [разворот]"59811  "^ff0000Пустота: Очищение^ffcb4aПодготовка: ^ffffffмгновенно^ffcb4aПерезарядка: ^ffffff60,0 ^ffcb4aсек.^FFFFFFНа ^96f5ff20^FFFFFF сек. с вероятностью ^96f5ff10%%^FFFFFF сбрасывает перезарядку всех умений, кроме применяемого."*/ 
