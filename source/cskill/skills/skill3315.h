...
/* 
33150  "Умение предмета: усиление атаки и защита, увеличение здоровья"33151  "Увеличивает урон от оружия на 60%, защиту от снаряжения на 30%, максимальный запас здоровья на 15%. Длительность: 30 минут. Пропадает после смерти, можно снять."*/ 
