...
/* 
28270  "Светлый пульс Тени"28271  "^ffffffСветлый пульс Тени^ffcb4aПассивный навык^ffcb4aСтатус: ^ffffffПросвещенный^ffffffВесь урон, получаемый персонажем от атак с расстояния более ^96f5ff8^ffffff м, уменьшается.Чем больше расстояние, тем сильнее эффект. Урон уменьшается не более чем на ^96f5ff76,19%%^ffffff. ^f7dfa5Эффект уменьшения урона увеличен до ^96f5ff79,19%%^f7dfa5."*/ 
