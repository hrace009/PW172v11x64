...
/* 
10000  "Жало"10001  "^ffffffЖало Начальное умение джинна^ffcb4aДальность: ^ffffff25 м^ffcb4aЗатраты энергии: ^96f5ff%d^ffffff^ffcb4aЗатраты физической силы: ^96f5ff%d^ffffff^ffcb4aПрименение: ^ffffffмгновенное^ffcb4aПерезарядка: ^ffffff15^ffcb4a сек.^ffcb4aОграничения: ^ffffffнетВыстреливает в противника отравленным жалом.Уменьшает скорость его передвижения на %d%% на 5 сек.Увеличивает вашу скорость на %d%% на 5 секунд.За каждые 4 уровня джинна затраты энергии снижаются на 1 ед.^72fe00Влияние ловкости: каждые 20 очков увеличивают время замедления и ускорения на 1 сек."*/ 
