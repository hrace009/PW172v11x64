...
/* 
40330  "Великое дьявольское проклятие"40331  "^ff5c00Великое дьявольское проклятие^ffcb4aДальность: ^96f5ff27^ffffff ^ffcb4aм^ffcb4aМаг. энергия: ^96f5ff300^ffcb4aПодготовка: ^ffffff5,0 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff0,8 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff2,0 ^ffcb4aсек.^ffcb4aПолучение ци: ^ffffff0,2^ffcb4aОграничение по оружию: ^ffffffмагическое оружие, без оружия^ffcb4aХарактеристика: ^ff5c00Храбрость^ffcb4aСтатус: ^ffffffАсураКонцентрируя энергию, насылает на противника волшебное облако, которое наносит персонажам мин. ^96f5ff50%%^ffffff базового маг. урона плюс ^96f5ff2900^ffffff ед. физ. урона,а монстрам - ^96f5ff100%%^ffffff базового маг. урона плюс ^96f5ff5800^ffffff ед. физ. урона.Умение не может нанести крит. удар, но с вероятностью, в три раза превыш. шанс крит. удара, наносит ^96f5ff130%%^ffffff урона.Чем дольше концентр. энергия, тем выше урон.Прерывает подг. заклинаний у цели.^ffeaabЭффект серебряной руны:@1^ffeaab1-4 ур.: при максимальной концентрации, добавляется ^96f5ff40%%^ffeaab урона от маг. атаки^ffeaab5-7 ур.: при максимальной концентрации, добавляется ^96f5ff60%%^ffeaab урона от маг. атаки^ffeaab8-9 ур.: при максимальной концентрации, добавляется ^96f5ff80%%^ffeaab урона от маг. атаки^ffeaab 10 ур.: при максимальной концентрации, добавляется ^96f5ff100%%^ffeaab урона от маг. атаки@1@2^ffeaabПри макс. концентр., добавляется ^96f5ff%d%%^ffeaab урона от маг. атаки.@2"*/ 
...
bool BlessMe (Skill * skill) const
        ...
        {
            return (float) (((2 * (player->GetPuremagicattack () * 1.25 + 2900) * (player->GetRand () < player->GetCrit () * 3 ? 1.3 : 1)) * player->GetCharging () / 5000));
        }
#endif 
#ifdef _SKILL_SERVER 
