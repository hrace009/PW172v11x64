...
/* 
46770  "Помощь демона"46771  "Помощь демона: сила демона повышает атаку на 300%%,защиту на 100%%, здоровье на 50%%.Эффект длится 30 сек., при активации восстанавливается 50%% максимального здоровья."*/ 
