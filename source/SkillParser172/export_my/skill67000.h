#ifndef __CPPGEN_GNET_SKILL67000
#define __CPPGEN_GNET_SKILL67000
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill67000:public Skill
    {
      public:
        enum
        { SKILL_ID = 67000 };
          Skill67000 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill67000Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
...
#endif
      Skill67000Stub ():SkillStub (67000)
        {
            cls = 127;
            name = L"�س���";
            nativename = "�س���";
