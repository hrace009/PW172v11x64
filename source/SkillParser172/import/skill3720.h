...
37200  "Великое каменное проклятие"
37201  "^ff5c00Великое каменное проклятие
...
С вероятностью ^96f5ff25%%^ffffff снижает защиту цели на ^96f5ff180%%^ffffff. 
