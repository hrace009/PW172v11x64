...
{ 
    ...
    { 
        ...
        {        
            float rapel = 0.0f;
			if(skill->GetSection () == 1) rapel = 100.0f; // отталкивает только первым ударом

			// отталкивает если цель находится на расстоянии до 10 метров
...
#endif 
#ifdef _SKILL_SERVER 
        float GetTalent0 (PlayerWrapper * player) const // расстояние до цели
        {
