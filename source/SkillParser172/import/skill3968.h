...
{ 
    ...
    { 
        static int array[10] = { 53968,53968,53968,53968,53968,53968,53968,53968,53968,53968 }; 
        return array[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        static float array[10] = { 70,70,70,70,70,70,70,70,70,70 }; 
        return array[skill->GetLevel () - 1]; 
    } 
