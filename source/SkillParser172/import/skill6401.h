...
64010  "Великий отпечаток места"
64011  "^ff5c00Великий отпечаток места
...
Запоминает текущее положение противника и со ^96f5ff100%%^ffffff-ной вероятностью
возвращает его в эту точку через ^96f5ff6^ffffff сек.
^a6caf0Умение действует только на игроков.
