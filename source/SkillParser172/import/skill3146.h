...
namespace GNET
{
    ...
    bool BlessMe (Skill * skill) const { return true; } 
    bool TakeEffect (Skill * skill) const { return true; } 
    float GetEffectdistance (Skill * skill) const { return 100; } 
    int GetAttackspeed (Skill * skill) const { return 16; } 
    float GetHitrate (Skill * skill) const { return 3; } 
#endif
    };
}
#endif
