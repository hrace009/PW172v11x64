...
44280  "Великое невидимое лезвие"
44281  "^ff5c00Великое невидимое лезвие
...
^ff0000С некоторой вероятностью может сбросить время перезарядки 'Великого невидимого лезвия'. 
^ff00001-4 ур.: с вероятностью ^96f5ff20%%^ff0000 сбрасывает время перезарядки умения
^ff00005-7 ур.: с вероятностью ^96f5ff30%%^ff0000 сбрасывает время перезарядки умения
^ff00008-9 ур.: с вероятностью ^96f5ff40%%^ff0000 сбрасывает время перезарядки умения
 ^ff000010 ур.: с вероятностью ^96f5ff50%%^ff0000 сбрасывает время перезарядки умения@1@2
^ff0000С вероятностью ^96f5ff%d%%^ff0000 может сбросить время перезарядки 'Великого невидимого лезвия'.@2"
*/
...
{ 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
			...
			^ff00005-7 ур.: с вероятностью ^96f5ff30%%^ff0000 сбрасывает время перезарядки умения
			^ff00008-9 ур.: с вероятностью ^96f5ff40%%^ff0000 сбрасывает время перезарядки умения
			^ff000010 ур.: с вероятностью ^96f5ff50%%^ff0000 сбрасывает время перезарядки умения
			*/
			// меч императора
