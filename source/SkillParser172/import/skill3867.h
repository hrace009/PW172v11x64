...
38670  "Великий загнанный зверь"
38671  "^ff5c00Великий загнанный зверь 
...
{ 
    ...
    { 
		...
		^00ff005-7 ур.: перезарядка сокращается до ^96f5ff240^00ff00 сек.
		^00ff008-9 ур.: перезарядка сокращается до ^96f5ff220^00ff00 сек.
		^00ff00 10 ур.: перезарядка сокращается до ^96f5ff200^00ff00 сек.
		*/
        static int aarray[10] = { 260000,260000,260000,260000,240000,240000,240000,220000,220000,200000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
