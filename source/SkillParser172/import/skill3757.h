...
/* 
37570  "Великое проклятие уязвимости"37571  "^ff5c00Великое проклятие уязвимости^ffcb4aНеобходимо обращение в лисицу^ffcb4aДальность: ^ffffff10 ^ffcb4aм^ffcb4aМаг. энергия: ^96f5ff%d^ffffff^ffcb4aПодготовка: ^ffffff1,5^ffcb4a сек.^ffcb4aПрименение: ^ffffff1,2^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff30 ^ffcb4aсек.^ffcb4aПолучение ци: ^ffffff0,1^ffcb4aОграничение по оружию: ^ffffffмагическое оружие, без оружия^ffcb4aХарактеристика: ^ff5c00Мощь^ffcb4aСтатус: ^ffffffАсураУвеличивает урон, получаемый целью, на ^96f5ff%d%%^ffffff на ^96f5ff26^ffffff сек.^a6caf0В каждый момент времени на персонажа может действовать только одно проклятие.^ffcb4aЭффект золотой руны:@1^ffcb4aУмение наносит прямой урон.^ffcb4a1-4 ур.: наносит физ. урон, равный ^96f5ff60%%^ffcb4a базового физ. и маг. урона^ffcb4a5-7 ур.: наносит физ. урон, равный ^96f5ff80%%^ffcb4a базового физ. и маг. урона^ffcb4a8-9 ур.: наносит физ. урон, равный ^96f5ff100%%^ffcb4a базового физ. и маг. урона^ffcb4a 10 ур.: наносит физ. урон, равный ^96f5ff120%%^ffcb4a базового физ. и маг. урона@1@2^ffcb4aНаносит физ. урон, равный ^96f5ff%d%%^ffcb4a базового физ. и маг. урона.@2"*/ 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				static const float LEVEL_8_9 = 1.00;
				...
				skill->GetPlayer ()->SetDecmp (120); // забирает ману
                skill->SetPlus (50); // статический урон
