...
{ 
    ...
    { 
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (3937); // �� �ܧѧܧ�ԧ� ��ܧڧݧݧ� �ߧѧ�ڧߧѧ�� 
