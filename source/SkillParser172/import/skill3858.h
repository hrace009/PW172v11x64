...
38580  "Великий сбитый дракон"
38581  "^ff5c00Великий сбитый дракон 
...
^ffeaab1-4 ур.: перезарядка сокращается до ^96f5ff54^ffeaab сек.
^ffeaab5-7 ур.: перезарядка сокращается до ^96f5ff51^ffeaab сек.
^ffeaab8-9 ур.: перезарядка сокращается до ^96f5ff48^ffeaab сек.
^ffeaab 10 ур.: перезарядка сокращается до ^96f5ff45^ffeaab сек.@1@2
^ffeaabПерезарядка сокращается до ^96f5ff%d^ffeaab сек.@2"
*/
...
{ 
    ...
    { 
        cls                 = 4; 
        name                = L"ЙсЎ¤Бъ·Йѕш"; 
        nativename          = "ЙсЎ¤Бъ·Йѕш"; 
        icon                = "ЙсЎ¤Бъ·Йѕш°Ч.dds"; 
        max_level           = 1; 
        type                = 1; 
        allow_ride          = 0; 
        attr                = 7; 
        ...
        combosk_interval    = 0; 
        combosk_nobreak     = 0; 
        effect              = "СэКЮ_КЮБйЦ®Б¦.sgc"; 
        aerial_effect       = ""; 
        range.type          = 3; 
        has_stateattack     = 0; 
        runes_attr          = 2; 
        gfxfilename         = "АдИґК±јдјхЙЩ.gfx"; 
    ...
    { 
        static int aarray[10] = { 54000,54000,54000,54000,51000,51000,51000,48000,48000,45000 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
