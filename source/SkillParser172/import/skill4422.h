...
{ 
    ...
    {
        return (float) (0 + (skill->GetPlayer ()->GetCurweapon () == 5 ? 18 : 0)); //копье +18 дальности
    }
    ...
    {
		return (float) (skill->GetPlayer ()->GetRange () + (skill->GetPlayer ()->GetCurweapon () == 5 ? 18 : 0)); //копье +18 дальности
    }
