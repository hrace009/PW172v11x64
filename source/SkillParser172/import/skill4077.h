...
/* 
40770  "Великая трава жизни"40771  "^ff5c00Великая трава жизни^ffcb4aДальность: ^96f5ff27^ffffff м^ffcb4aМаг. энергия: ^96f5ff850^ffffff^ffcb4aПодготовка: ^ffffff1,0^ffcb4a сек.^ffcb4aПрименение: ^ffffff1,0^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff35,0^ffcb4a сек.^ffcb4aОграничение по оружию: ^ffffffмагическое оружие, без оружия^ffcb4aХарактеристика: ^ff5c00Мощь^ffcb4aСтатус: ^ffffffМудрецПризывает рядом с мистиком исцеляющее растение, которое помогает в бою.Каждую секунду у союзников восстанавливается здоровье на ^96f5ff5%%^ffffff урона оружия. Эффект лечения может совмещаться.Каждую секунду восстанавливает здоровье, равное ^96f5ff20%%^ffffff урона оружия плюс ^96f5ff200^ffffff ед.,повышает скорость восстановления ЖС до ^96f5ff70^ffffff ед. в секунду течение ^96f5ff20^ffffff сек.^a6caf0Трава жизни не подвержена эффекту заклинания 'Ярость флоры'.^a6caf0Дополнительная стоимость: ^ffffff1^a6caf0 ци.^ffcb4aЭффект золотой руны:@1^96f5ffРастение неуязвимо.^ffcb4a1-4 ур.: растение живет ^96f5ff6^ffcb4a сек.^ffcb4a5-7 ур.: растение живет ^96f5ff9^ffcb4a сек.^ffcb4a8-9 ур.: растение живет ^96f5ff12^ffcb4a сек.^ffcb4a 10 ур.: растение живет ^96f5ff15^ffcb4a сек.@1@2Растение неуязвимо, живет ^96f5ff%d^ffcb4a сек.@2"*/ 
...
{ 
    ...
    { 
        static float aarray[10] = { 479,479,479,479,479,479,479,479,479,479 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        ...
        {            
			static const float LEVEL_1_4 = 6000;
			static const float LEVEL_5_7 = 9000;
			static const float LEVEL_8_9 = 12000;
			static const float LEVEL_10_10 = 15000;
