...
{ 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetRatio (3 + (skill->GetPlayer ()->GetAp () / 50)); // 100 §é§Ú = 2
    ...
    { 
        static float array[10] = { 125,125,125,125,125,125,125,125,125,125 }; 
        return array[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
			...
			// §Ò§Ñ§æ §Ü §Þ§Ö§ä§Ü§à§ã§ä§Ú §à§ä §Ù§Ñ§ä§â§Ñ§é§Ö§ß§à§Ô§à §é§Ú
            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetTime (10000);
            skill->GetVictim ()->SetRatio (skill->GetPlayer ()->GetAp () * 0.1); // 0.01 §é§Ú = 10% §Þ§Ö§ä§Ü§à§ã§ä§Ú
