...
24330  "Демонический перистый барьер"
24331  "^ffff00Демонический перистый барьер
...
Лучник закрывается магическим щитом, поглощающим до ^96f5ff80%%^ffffff входящего урона.
Запас прочности щита составляет ^96f5ff20%%^ffffff от максимального запаса здоровья, время действия - ^96f5ff20^ffffff сек.
Каждые ^96f5ff3^ffffff сек. щит восстанавливает ^96f5ff80^ffffff ед. МЭ, до ^96f5ff6^ffffff раз.

^a6caf0Дополнительная стоимость: ^ffffff0,45^a6caf0 ци.

^d618e7Увеличивает время действия щита до ^96f5ff30^d618e7 сек."
*/
...
{ 
    ...
    { 
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetPlayer ()->GetHp () * 0.2); 
