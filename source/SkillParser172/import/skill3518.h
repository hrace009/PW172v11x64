...
/* 
35180  "Великая кровавая стрела"35181  "^ff5c00Великая кровавая стрела^ffcb4aДальность: ^ffffffдальняя атака^ffcb4aПодготовка: ^ffffff1,5 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff0,6 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff2 ^ffcb4aмин.^ffcb4aОграничение по оружию: ^ffffffоружие дальнего боя^ffcb4aХарактеристика: ^ff5c00Храбрость^ffcb4aСтатус: ^ffffffМудрецНаносит противнику базовый физ. урон, плюс ^96f5ff150%%^ffffff урона оружия, плюс ^96f5ff4444^ffffff ед.На ^96f5ff30^ffffff сек. снижает макс. запас ЖС противника на ^96f5ff18%%^ffffff и увеличивает получаемый им урон на ^96f5ff25%%^ffffff.Кроме того, в течение ^96f5ff9^ffffff сек. наносит противнику урон стихией металла, равный ^96f5ff150%%^ffffff базового урона плюс ^96f5ff4444^ffffff ед.Не промахивается.^a6caf0Дополнительная стоимость: ^ffffff1^a6caf0 ци.^00ff00Эффект изумрудной руны:@1^00ff001-4 ур.: длительный урон стихией металла повышается до ^96f5ff170%%^00ff00 от силы базовой атаки^00ff005-7 ур.: длительный урон стихией металла повышается до ^96f5ff180%%^00ff00 от силы базовой атаки^00ff008-9 ур.: длительный урон стихией металла повышается до ^96f5ff190%%^00ff00 от силы базовой атаки^00ff00 10 ур.: длительный урон стихией металла повышается до ^96f5ff200%%^00ff00 от силы базовой атаки@1@2Длительный урон стихией металла повышается до ^96f5ff%d%%^00ff00 от силы базовой атаки.@2"*/ 
    ...
    public: 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				static const float LEVEL_1_4 = 1.70;
				static const float LEVEL_5_7 = 1.80;
				static const float LEVEL_8_9 = 1.90;
                ...
                skill->SetPlus (4444); // статический урон
                skill->SetRatio (1.5 + aarray[skill->GetLevel () - 1]); // урон от оружия
                skill->SetDamage (skill->GetAttack ()); // вставляется урон от огня
