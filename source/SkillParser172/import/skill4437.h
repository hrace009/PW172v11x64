...
44370  "Великий зов ветра"
44371  "^ff5c00Великий зов ветра
...
Увеличивает скорость перемещения ^ff5c00шамана^ffffff на суше и в воздухе
на ^96f5ff60%%^ffffff, а скорость в воде на ^96f5ff100%%^ffffff на ^96f5ff15^ffffff сек. Кроме того, на ^96f5ff5^ffffff сек.
шаман получает иммунитет к эффектам, ограничивающим передвижение.

^ffcb4aЭффект золотой руны:@1
^ffcb4a1-4 ур.: время перезарядки сокращается до ^96f5ff80^ffcb4a сек.
^ffcb4a5-7 ур.: время перезарядки сокращается до ^96f5ff70^ffcb4a сек.
^ffcb4a8-9 ур.: время перезарядки сокращается до ^96f5ff60^ffcb4a сек.
 ^ffcb4a10 ур.: время перезарядки сокращается до ^96f5ff50^ffcb4a сек.@1@2
^ffcb4aВремя перезарядки сокращается до ^96f5ff%d^ffcb4a сек.@2"
*/
...
{ 
    ...
    { 
		...
		^ffcb4a5-7 ур.: время перезарядки сокращается до ^96f5ff70^ffcb4a сек.
		^ffcb4a8-9 ур.: время перезарядки сокращается до ^96f5ff60^ffcb4a сек.
		^ffcb4a10 ур.: время перезарядки сокращается до ^96f5ff50^ffcb4a сек
		*/
