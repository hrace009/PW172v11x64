...
{ 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (skill->GetT0 () * 2.0);
...
bool BlessMe (Skill * skill) const
        {            
			...
			static const float LEVEL_8_9 = 40;
			static const float LEVEL_10_10 = 50;
