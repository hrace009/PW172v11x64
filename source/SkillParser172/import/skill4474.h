...
{ 
    ...
    {
        static int array[10] = { 28000,28000,28000,28000,28000,28000,28000,28000,28000,28000 };
        return array[skill->GetLevel () - 1];
    }
    ...
    {
            return (float) (0 + skill->GetPlayer ()->GetForm () == 1 ? 10 : 0);
        }
    ...
    {
            return (float) (27 + skill->GetPlayer ()->GetForm () == 1 ? 10 : 0);
        }
    float GetMpcost (Skill * skill) const 
    { 
        static float array[10] = { 119,119,119,119,119,119,119,119,119,119 }; 
        return array[skill->GetLevel () - 1]; 
    } 
...
bool BlessMe (Skill * skill) const
        ...
        {
            return (float) (30 + skill->GetPlayer ()->GetForm () == 1 ? 10 : 0);
        }		
#endif 
#ifdef _SKILL_SERVER 
