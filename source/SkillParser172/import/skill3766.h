...
/* 
37660  "Великое проклятие истощения"37661  "^ff5c00Великое проклятие истощения^ffcb4aНеобходимо обращение в лисицу^ffcb4aДальность: ^ffffff10 ^ffcb4aм^ffcb4aМаг. энергия: ^96f5ff%d^ffcb4aПодготовка: ^ffffff1,5 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff1,2 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff30 ^ffcb4aсек.^ffcb4aПолучение ци: ^ffffff0,5^ffcb4aОграничение по оружию: ^ffffffмаг. оружие, без оружия^ffcb4aХарактеристика: ^ff5c00Мощь^ffcb4aСтатус: ^ffffffАсураЗаставляет противника потерять большое количество ци, когда ци недостаточно, цели наносится урон.При нехватке каждого ^96f5ff0,01^ffffff ци, наносится урон в размере ^96f5ff1%%^ffffff от уровня здоровья.Уровень здоровья определяется как меньшее значение при сравнении максимумов здоровья цели и игрока.Действует только на игроков.^a6caf0В каждый момент времени на персонажа может действовать только одно проклятие.^ff0000Эффект рубиновой руны:@1^ff00001-4 ур.: немедленно отнимает у цели ^96f5ff0,4^ff0000 ци^ff00005-7 ур.: немедленно отнимает у цели ^96f5ff0,6^ff0000 ци^ff00008-9 ур.: немедленно отнимает у цели ^96f5ff0,8^ff0000 ци^ff0000 10 ур.: немедленно отнимает у цели ^96f5ff1^ff0000 ци@1@2^ff0000Немедленно отнимает у цели ^96f5ff%d^ff0000 ед. ярости.@2"*/ 
...
{ 
    ...
    { 
        ...
        {
			float _glyph = get_glyph( (skill->GetLevel () - 1), 40, 60, 80, 100 );
