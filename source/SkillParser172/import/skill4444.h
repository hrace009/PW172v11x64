...
44440  "Великий крылатый ветер"
44441  "^ff5c00Великий крылатый ветер
...
{ 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
			...
			^ffeaab5-7 ур.: длительность эффекта составляет ^96f5ff6^ffeaab сек.
			^ffeaab8-9 ур.: длительность эффекта составляет ^96f5ff8^ffeaab сек.
			^ffeaab10 ур.: длительность эффекта составляет ^96f5ff10^ffeaab сек.			
			*/
			
			// подбрасывает его в воздух на высоту ^96f5ff20^ffffff м ????????????????????
