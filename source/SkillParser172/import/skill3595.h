...
35950  "Великое проклятие духов земли"
35951  "^ff5c00Великое проклятие духов земли
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				^ffcb4a5-7 ур.: добавляется ^96f5ff30%%^ffcb4a урона оружия
				^ffcb4a8-9 ур.: добавляется ^96f5ff40%%^ffcb4a урона оружия
				^ffcb4a 10 ур.: добавляется ^96f5ff50%%^ffcb4a урона оружия
				*/
                ...
                skill->SetRatio (2.0 + ( aarray[skill->GetLevel () - 1] ));
