          ...
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				*/
				...
				static float array[10] = { 1.1,1.1,1.1,1.1,1.4,1.4,1.4,1.7,1.7,2.0 }; 
				
                skill->GetPlayer ()->SetDecmp (112);
                skill->SetPlus (skill->GetPlayer ()->GetCurweapon () != 1 ? 2800 : 1864);
                skill->SetRatio (skill->GetPlayer ()->GetCurweapon () != 1 ? 0 : array[skill->GetLevel () - 1]);
                skill->SetDamage (skill->GetAttack ());
                skill->GetPlayer ()->SetPerform (1);
            }
            bool Interrupt (Skill * skill) const
