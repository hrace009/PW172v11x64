        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				static const float LEVEL_5_7 = 0.70;
				static const float LEVEL_8_9 = 0.80;
				static const float LEVEL_10_10 = 0.90;
