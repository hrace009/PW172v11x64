...
44250  "Великое невидимое лезвие"
44251  "^ff5c00Великое невидимое лезвие
...
Повышает шанс нанесения критического удара до ^96f5ff100%%^ffffff на время, зависящее от уровня руны.

^ffcb4aЭффект золотой руны:@1
^ffcb4a1-4 ур.: эффект длится ^96f5ff6^ffcb4a сек.
^ffcb4a5-7 ур.: эффект длится ^96f5ff8^ffcb4a сек.
^ffcb4a8-9 ур.: эффект длится ^96f5ff10^ffcb4a сек.
 ^ffcb4a10 ур.: эффект длится ^96f5ff12^ffcb4a сек.@1@2
^ffcb4aЭффект длится ^96f5ff%d^ffcb4a сек.@2"
*/
...
{ 
    ...
    { 
        ...
        {
			/**
			Повышает шанс нанесения критического удара до ^96f5ff100%%^ffffff на время, зависящее от ур

			^ffcb4a1-4 ур.: эффект длится ^96f5ff6^ffcb4a сек.
			^ffcb4a5-7 ур.: эффект длится ^96f5ff8^ffcb4a сек.
			^ffcb4a8-9 ур.: эффект длится ^96f5ff10^ffcb4a сек.
			^ffcb4a10 ур.: эффект длится ^96f5ff12^ffcb4a сек.
			*/
