...
38630  "Великое неистовство зверя"
38631  "^ff5c00Великое неистовство зверя
...
^ff00001-4 ур.: щит максимально поглощает маг. урон в количестве до ^96f5ff60%%^ff0000 от базовой физ. атаки оборотня.
^ff00005-7 ур.: щит максимально поглощает маг. урон в количестве до ^96f5ff65%%^ff0000 от базовой физ. атаки оборотня.
^ff00008-9 ур.: щит максимально поглощает маг. урон в количестве до ^96f5ff70%%^ff0000 от базовой физ. атаки оборотня.
^ff0000 10 ур.: щит максимально поглощает маг. урон в количестве до ^96f5ff75%%^ff0000 от базовой физ. атаки оборотня.@1@2
^ff0000Щит максимально поглощает маг. урон в количестве до ^96f5ff%d%%^ff0000 от базовой физ. атаки оборотня.@2"
*/
...
{ 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetT0 () * (0.50 + ( aarray[skill->GetLevel () - 1] )));
...
bool BlessMe (Skill * skill) const
        ...
        {
            return (float) (player->GetAttack ()); // физ атака базовая
        }
#endif 
#ifdef _SKILL_SERVER 
