...
54580  "Великий кровавый меч"
54581  "^ff5c00Великий кровавый меч
...
^00ffff1-4 ур.: радиус действия умения увеличивается до ^ffffff13^00ffff м
^00ffff5-7 ур.: радиус действия умения увеличивается до ^ffffff14^00ffff м
^00ffff8-9 ур.: радиус действия умения увеличивается до ^ffffff15^00ffff м
 ^00ffff10 ур.: радиус действия умения увеличивается до ^ffffff16^00ffff м@1@2
^00ffffРадиус действия умения увеличивается до ^ffffff%d^00ffff м.@2"
*/
...
{ 
    ...
    { 
        ...
        float GetRadius (Skill * skill) const
        {
			...
			^00ffff5-7 ур.: радиус действия умения увеличивается до ^ffffff14^00ffff м
			^00ffff8-9 ур.: радиус действия умения увеличивается до ^ffffff15^00ffff м
			^00ffff10 ур.: радиус действия умения увеличивается до ^ffffff16^00
			*/
			static const int LEVEL_1_4 = 1;
			static const int LEVEL_5_7 = 2;
			static const int LEVEL_8_9 = 3;
			static const int LEVEL_10_10 = 4;
            ...
            return (float) (12 + ( aarray[skill->GetLevel () - 1] ));
        }
