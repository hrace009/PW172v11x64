...
34990  "Великая связывающая стрела"
34991  "^ff5c00Великая связывающая стрела
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				^ffcb4a5-7 ур.: добавляется ^96f5ff120%%^ffcb4a урона оружия
				^ffcb4a8-9 ур.: добавляется ^96f5ff160%%^ffcb4a урона оружия
				^ffcb4a 10 ур.: добавляется ^96f5ff200%%^ffcb4a урона оружия
				*/
