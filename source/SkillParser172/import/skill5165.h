...
{ 
    ...
    { 
        static int array[10] = { 60724,60724,60724,60724,60724,60724,60724,60724,60724,60724 }; 
        return array[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        static float array[10] = { 185,185,185,185,185,185,185,185,185,185 }; 
        return array[skill->GetLevel () - 1]; 
    } 
