    ...
    public: 
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            {
                skill->SetSection (1);
                skill->SetPlus (5442 * skill->GetPlayer ()->GetForm () == 1 ? 1.2 : 0);
                skill->SetRatio (1.8 * skill->GetPlayer ()->GetForm () == 1 ? 1.2 : 0);
                skill->GetPlayer ()->SetAddball (1);
                skill->SetWaterdamage ((0.25 * skill->GetMagicattack ()) * skill->GetPlayer ()->GetForm () == 1 ? 1.2 : 0);
