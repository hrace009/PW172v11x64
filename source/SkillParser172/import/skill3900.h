        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (skill->GetPlayer ()->GetCurweapon () != 1 ? 9697 : 6839);
 				skill->SetRatio ((skill->GetPlayer ()->GetCurweapon () != 1 ? 4.0 : 2.5) + aarray[skill->GetLevel () - 1]);
