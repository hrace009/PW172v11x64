...
50430  "Великие девять солнц"
50431  "^ff5c00Великие девять солнц
...
^ffeaab1-4 ур.: добавляется ^96f5ff36%%^ffeaab базового физ. урона
^ffeaab5-7 ур.: добавляется ^96f5ff54%%^ffeaab базового физ. урона
^ffeaab8-9 ур.: добавляется ^96f5ff72%%^ffeaab базового физ. урона
 ^ffeaab10 ур.: добавляется ^96f5ff90%%^ffeaab базового физ. урона@1@2
^ffeaabПозволяет использовать умение дважды и дополнительно наносит ^96f5ff%d%%^ffeaab базового физ. урона.@2
*/
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				^ffeaab5-7 ур.: добавляется ^96f5ff54%%^ffeaab базового физ. урона
				^ffeaab8-9 ур.: добавляется ^96f5ff72%%^ffeaab базового физ. урона
				^ffeaab10 ур.: добавляется ^96f5ff90%%^ffeaab базового физ. урона
				*/
                skill->SetSection (1);
                skill->SetPlus (0);
                skill->SetRatio (0);
