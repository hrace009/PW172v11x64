...
/* 
52200  "Великий щит духов"52201  "^ff5c00Великий щит духов^ffcb4aМаг. энергия: ^96f5ff158,7^ffffff^ffcb4aПодготовка: ^ffffffмгновенно ^ffcb4aПерезарядка: ^ffffff90 ^ffcb4aсек.^ffcb4aОграничение по оружию: ^ffffffмеч и щит, без оружия^ffcb4aХарактеристика: ^ff5c00Мощь^ffcb4aСтатус: ^ffffffМудрецЭнергия щита преобразуется в кольцо мстительных духов. В течение ^96f5ff10^ffffff сек.каждые ^96f5ff2^ffffff сек. всем противникам, находящимся в пределах ^96f5ff12^ffffff м от паладина,наносится базовый физический урон плюс ^96f5ff8255^ffffff ед. физического урона.Данное умение не может нанести критический урон, но с вероятностью, в 2 разапревышающей шанс критического удара, наносит ^96f5ffполуторакратный^ffffff урон.^FFFF00Можно применять под действием эффектов, ограничивающих передвижение и подготовку заклинаний.^a6caf0Дополнительная стоимость: ^ffffff100^a6caf0 ед. энергии щита.^ffcb4aЭффект золотой руны:@1^ffcb4a1-4 ур.: добавляется ^96f5ff50%%^ffcb4a урона оружия^ffcb4a5-7 ур.: добавляется ^96f5ff100%%^ffcb4a урона оружия^ffcb4a8-9 ур.: добавляется ^96f5ff150%%^ffcb4a урона оружия ^ffcb4a10 ур.: добавляется ^96f5ff200%%^ffcb4a урона оружия@1@2К наносимому урону добавляется ^96f5ff%d%%^ffcb4a урона оружия.@2"*/ 
    ...
    public: 
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				static const float LEVEL_1_4 = 0.50;
				static const float LEVEL_5_7 = 1.00;
				static const float LEVEL_8_9 = 1.50;
				static const float LEVEL_10_10 = 2.00;
