...
{ 
    ...
    {
        static int array[10] = { 240000,240000,240000,240000,240000,240000,240000,240000,240000,240000 };
    ...
    { 
        static float array[10] = { 800,800,800,800,800,800,800,800,800,800 }; 
        return array[skill->GetLevel () - 1]; 
    } 
