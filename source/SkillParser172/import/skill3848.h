        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetDamage (skill->GetPlus () + skill->GetAttack () * _glyph);
                skill->SetRatio (1);
