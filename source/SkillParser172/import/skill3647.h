...
36470  "Великий дух мести: отдача"
36471  "^ff5c00Великий дух мести: отдача
...
Если противник находится под эффектом молчания, то время действия эффекта отдачи увеличивается.
^ffeaab1-4 ур.: эффект отдачи длится ^96f5ff14^ffeaab сек.
^ffeaab5-7 ур.: эффект отдачи длится ^96f5ff16^ffeaab сек.
^ffeaab8-9 ур.: эффект отдачи длится ^96f5ff18^ffeaab сек.
^ffeaab 10 ур.: эффект отдачи длится ^96f5ff20^ffeaab сек.@1@2
*/
