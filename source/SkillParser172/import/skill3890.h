        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				static const float A_LEVEL_1_4 = 0.4;
				static const float A_LEVEL_5_7 = 0.6;
				static const float A_LEVEL_8_9 = 0.8;
				static const float A_LEVEL_10_10 = 1.0;
