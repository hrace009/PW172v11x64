...
38430  "Великий тысячетонный молот"
38431  "^ff5c00Великий тысячетонный молот
...
{ 
    ...
    { 
        cls                 = 4; 
        name                = L"ЙсЎ¤З§Ѕпґё"; 
        nativename          = "ЙсЎ¤З§Ѕпґё"; 
        icon                = "ЙсЎ¤З§ЅпґёВМ.dds"; 
        max_level           = 1; 
        type                = 1; 
        allow_ride          = 0; 
        attr                = 7; 
        ...
        combosk_interval    = 0; 
        combosk_nobreak     = 0; 
        effect              = "СэКЮ_РВЗ§Ѕпґё_»чЦР.sgc"; 
        aerial_effect       = ""; 
        range.type          = 0; 
        has_stateattack     = 0; 
        runes_attr          = 2; 
        gfxfilename         = "К©·ЕѕаАлФцјУ.gfx"; 
    ...
    float GetRadius (Skill * skill) const
    {
			...
			^00ff005-7 ур.: дальность увеличивается на ^96f5ff3^00ff00 м
			^00ff008-9 ур.: дальность увеличивается на ^96f5ff4^00ff00 м
			^00ff00 10 ур.: дальность увеличивается на ^96f5ff5^00ff00 м
			*/
