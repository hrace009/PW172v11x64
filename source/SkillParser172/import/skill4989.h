...
{ 
    ...
    { 
        static int aarray[10] = { 60782,60782,60782,60782,60782,60782,60782,60782,60782,60782 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
            ...
            float rapel = 0.0f;
			if(skill->GetSection () == 1) rapel = 100.0f;
