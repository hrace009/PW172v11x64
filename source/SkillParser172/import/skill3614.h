...
36140  "Великие проклятые пески"
36141  "^ff5c00Великие проклятые пески
...
Снижает защиту противников от стихий земли и воды на ^96f5ffпроцент, зависящий от уровня руны^ffffff, на ^96f5ff8^ffffff сек.

^00ff00Эффект изумрудной руны:@1
^00ff001-4 ур.: снижает защиту противников от земли и воды на ^96f5ff40%%^00ff00
^00ff005-7 ур.: снижает защиту противников от земли и воды на ^96f5ff50%%^00ff00
^00ff008-9 ур.: снижает защиту противников от земли и воды на ^96f5ff60%%^00ff00
^00ff00 10 ур.: снижает защиту противников от земли и воды на ^96f5ff70%%^00ff00@1@2
Снижает защиту противников от стихий земли и воды на ^96f5ff%d%%^00ff00.@2"
*/
...
{ 
    ...
    { 
        ...
        has_stateattack     = 0; 
        runes_attr          = 1; 
        gfxfilename         = "ёєГжЧґМ¬Р§№ыФцЗї1.gfx"; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
			...
			^00ff005-7 ур.: снижает защиту противников от земли и воды на ^96f5ff50%%^00ff00
			^00ff008-9 ур.: снижает защиту противников от земли и воды на ^96f5ff60%%^00ff00
			^00ff00 10 ур.: снижает защиту противников от земли и воды на ^96f5ff70%%^00ff00
			*/
			static const float LEVEL_1_4 = 0.4;
			static const float LEVEL_5_7 = 0.5;
			static const float LEVEL_8_9 = 0.6;
			static const float LEVEL_10_10 = 0.7;
