...
36030  "Великое проклятие песков"
36031  "^ff5c00Великое проклятие песков
...
^00ffff1-4 ур.: подготовка сокращается до ^ffffff1,6^00ffff сек.
^00ffff5-7 ур.: подготовка сокращается до ^ffffff1,4^00ffff сек.
^00ffff8-9 ур.: подготовка сокращается до ^ffffff1,2^00ffff сек.
...
{ 
          ...
          public:
            int GetTime (Skill * skill) const
            {
				...
				*/
				...
				static const int LEVEL_5_7 = 1400;
				static const int LEVEL_8_9 = 1200;
    ...
    { 
        cls                 = 2; 
        name                = L"ЙсЎ¤ЙієдЦд"; 
        nativename          = "ЙсЎ¤ЙієдЦд"; 
        icon                = "ЙсЎ¤ЙієдЦдА¶.dds"; 
        max_level           = 1; 
        type                = 1; 
        allow_ride          = 0; 
        attr                = 6; 
