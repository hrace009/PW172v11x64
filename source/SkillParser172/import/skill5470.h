...
54700  "Великая тревога души"
54701  "^ff5c00Великая тревога души
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				^ffcb4a5-7 ур.: добавляется ^96f5ff100%%^ffcb4a урона оружия
				^ffcb4a8-9 ур.: добавляется ^96f5ff150%%^ffcb4a урона оружия
				^ffcb4a10 ур.: добавляется ^96f5ff200%%^ffcb4a урона оружия
				*/
                skill->GetPlayer ()->SetDecmp (228);
                skill->SetPlus(9736);
				static const float LEVEL_1_4 = 0.5;
				static const float LEVEL_5_7 = 1.0;
				static const float LEVEL_8_9 = 1.5;
                ...
                skill->SetRatio(2.2 + ( aarray[skill->GetLevel () - 1] ));
