...
44090  "Великая ярость титана"
44091  "^ff5c00Великая ярость титана
...
Все атаки оборотня в течение ^96f5ff6^ffffff сек. становятся критическими
...
^00ffff1-4 ур.: эффект длится ^ffffff7^00ffff сек.
^00ffff5-7 ур.: эффект длится ^ffffff8^00ffff сек.
^00ffff8-9 ур.: эффект длится ^ffffff9^00ffff сек.
 ^00ffff10 ур.: эффект длится ^ffffff10^00ffff сек.@1@2
...
{ 
    ...
    { 
        ...
        has_stateattack     = 0; 
        runes_attr          = 3; 
        gfxfilename         = "ЧґМ¬іЦРшК±јдФці¤1.gfx"; 
