...
44290  "Великое невидимое лезвие"
44291  "^ff5c00Великое невидимое лезвие
...
{ 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
			...
			/*
			Увеличивает на ^96f5ff100%%^ffffff урон оружия на время, зависящее от уровня рун
			^ffeaab1-4 ур.: эффект длится ^96f5ff12^ffeaab сек.
			^ffeaab5-7 ур.: эффект длится ^96f5ff16^ffeaab сек.
			^ffeaab8-9 ур.: эффект длится ^96f5ff20^ffeaab сек.
			^ffeaab10 ур.: эффект длится ^96f5ff24^ffeaab сек
			*/
