...
{ 
    ...
    { 
        static int aarray[10] = { 30002,30002,30002,30002,30002,30002,30002,30002,30002,30002 }; 
    ...
    { 
        static int aarray[10] = { 42333,0,0,0,0,0,0,0,0,0 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        static float aarray[10] = { 1033,1033,1033,1033,1033,1033,1033,1033,1033,1033 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
