...
/* 
23080  "Исцеляющая аура"23081  "^ffffffИсцеляющая аура^ffcb4aМаг. энергия: ^96f5ff1^ffcb4aПодготовка: ^ffffff5,0 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff30,0 ^ffcb4aсек.^ffcb4aОграничение по оружию: ^ffffffмагическое оружие, без оружия^ffcb4aСтатус: ^ffffffнетЖрец создает целительную ауру, каждые ^96f5ff5^ffffff сек. затрачивая ^96f5ff500^ffffff ед. МЭ,и восстанавливает всем союзникам в радиусе ^96f5ff15^ffffff м здоровье в размере ^96f5ff20%%^ffffff базовой магической силы плюс ^96f5ff100^ffffff ед.Кроме того, получаемый урон снижается на ^96f5ff50%%^ffffff.Аура действует до тех пор, пока хватает МЭ или пока игрок не нажмет кнопку отмены."*/ 
