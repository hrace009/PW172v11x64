...
/* 
26380  "Гнев небес (буйство)"26381  "^ffffffГнев небес Уровень %d^ffcb4aДальность: ^ffffff8 ^ffcb4aм.^ffcb4aМаг. энергия: ^96f5ff%.1f^ffffff^ffcb4aПодготовка: ^ffffff0,4 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff1,5^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff30,0 ^ffcb4aсек.^ffcb4aОграничение по оружию: ^ffffffтопоры и молоты^ffcb4aСтатус: ^ffffffЗлойВоин концентрирует энергию и призывает пламенных драконов, которые наносят противникам в радиусе ^96f5ff12^ffffff мбазовый физический урон воина, плюс ^96f5ff%d%%^ffffff урона оружия, плюс^96f5ff%.1f^ffffff ед. Кроме того, в течение ^96f5ff6^ffffff сек. противникполучает на ^96f5ff%d%%^ffffff больше урона.^a6caf0Дополнительная стоимость: ^ffffff2^a6caf0 ци."*/ 
