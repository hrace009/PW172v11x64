        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (3580);
                skill->SetRatio (1.2 + skill->GetPlayer()->GetBalls() == 15 ? 2 : 0);
