...
{ 
    ...
    public: 
        ...
        { 
            static int aarray[10] = { 7,9,10,12,14,16,18,19,21,23 }; 
    ...
    public: 
        ...
        void Calculate (Skill * skill) const 
        { 
            static int aarray[10] = { 27,34,42,49,56,63,70,78,85,92 }; 
            skill->GetPlayer ()->SetDecmp (aarray[skill->GetLevel () - 1]); 
