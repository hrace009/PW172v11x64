...
{ 
    ...
    { 
        static float aarray[10] = { 112,124,136,148,160,172,184,196,208,220 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
