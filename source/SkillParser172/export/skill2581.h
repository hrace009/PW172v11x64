...
/* 
25810  "Прилив"25811  "^ffffffПрилив Ур. %d ^ffcb4aДальность: ^96f5ff%.1f^ffffff ^ffcb4aм ^ffcb4aМаг. энергия: ^96f5ff%.1f^ffffff^ffcb4aПодготовка: ^ffffff1,5^ffcb4a сек.^ffcb4aПрименение: ^ffffff1,0^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff10,0^ffcb4a сек.^ffcb4aПолучение ци: ^ffffff0,1^ffcb4aОграничение по оружию: ^ffffffкоса, без оружия^ffcb4aСтатус: ^ffffffОпытныйЖнец применяет энергию луны, чтобы вызвать прилив, который наносит всем противникам в радиусе ^96f5ff%.1f^ffffff мбазовый маг. урон, ^96f5ff%.1f%%^ffffff урона оружия и ^96f5ff%.1f^ffffff ед. урона стихией воды.Противники отбрасываются на ^96f5ff9^ffffff м. Дается ледяная сфера. Если у персонажа имеется2 Ледяные сферы и 1 Сфера грома, дальность отбрасывания увеличивается на ^96f5ff2^ffffff м."*/ 
