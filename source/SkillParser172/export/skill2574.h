...
{ 
    ...
    { 
        static float aarray[10] = { 148,171,193,216,238,261,283,306,328,351 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
