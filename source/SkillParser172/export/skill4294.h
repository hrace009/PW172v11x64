...
/* 
42940  "Обычная трансформация монстра"42941  "Трансформация монстра в желаемый вид по собственному выбору на 500 мсДля этого нужно в шаблоне монстра на место локальной переменной 2 вписать номер желаемого монстра"*/ 
