...
/* 
38800  "Великий дразнящий шлепок"38801  "^ff5c00Великий дразнящий шлепок^ffcb4aПерсонаж должен быть в образе тигра или панды^ffcb4aДальность: ^ffffffближний бой^ffcb4aМаг. энергия: ^96f5ff202^ffffff^ffcb4aПодготовка: ^ffffff0,4^ffcb4a сек.^ffcb4aПрименение: ^ffffff1^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff20^ffcb4a сек.^ffcb4aОграничение по оружию: ^ffffffтопоры и молоты, без оружия^ffcb4aХарактеристика: ^ff5c00Храбрость^ffcb4aСтатус: ^ffffffМудрецОборотень шлепает противника лапой, провоцируя его на атаку.В течение ^96f5ff4^ffffff сек. цель не может атаковать никого другого, кроме оборотня.На ^96f5ff5^ffffff сек. дополнительно устанавливается щит, поглощающий урон, равный ^96f5ff10%%^ffffff от максимального запаса ЖС.Также всегда снимает с цели ^96f5ff1^ffffff положительный эффект.^a6caf0Эффект провокации действует, только если цель - игрок.^a6caf0Дополнительная стоимость: ^ffffff0,35^a6caf0 ци.^00ffffЭффект сапфировой руны:@1^00ffffУменьшается время провокации цели, добавляется эффект обездвиживания.^00ffff1-4 ур.: длительность обездвиживания составляет ^ffffff1^00ffff сек.^00ffff5-7 ур.: длительность обездвиживания составляет ^ffffff2^00ffff сек.^00ffff8-9 ур.: длительность обездвиживания составляет ^ffffff3^00ffff сек.^00ffff 10 ур.: длительность обездвиживания составляет ^ffffff4^00ffff сек.@1@2^00ffffУменьшается время провокации цели, добавляется эффект обездвиживания на ^ffffff%d^00ffff сек.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        static float aarray[10] = { 202,202,202,202,202,202,202,202,202,202 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
