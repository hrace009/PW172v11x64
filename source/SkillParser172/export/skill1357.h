...
/* 
13570  "Сила тысячи зверей"13571  "^ffffffСила тысячи зверей Уровень %d^ffcb4aДальность: ^96f5ff%d^ffffff^ffcb4a м^ffcb4aМаг. энергия: ^96f5ff%.1f^ffffff^ffcb4aПодготовка: ^ffffff3,3^ffcb4a сек.^ffcb4aПрименение: ^ffffff2,0^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff15,0^ffcb4a сек.^ffcb4aОграничение по оружию: ^ffffffмечи^ffcb4aСтатус: ^ffffffЖестокийНаносит цели и всем противникам в радиусе ^96f5ff%.1f^ffffff м базовый физический урон,плюс ^96f5ff%d%%^ffffff урона оружия, плюс ^96f5ff%.1f^ffffff ед.Если противник находится под действием эффекта 'Око каменного змея', удар наносит дополнительный урон и снижает показатель атаки и защиты."*/ 
