...
/* 
52910  "Бесконечность превращений"52911  "^ff0000Бесконечность превращений %d ур.^ffffffПревращает вас в растущее дерево. Размер дерева может увеличиться до %d раз.Перезарядка: ^96f5ff%d^ffffff мин. Если вы будете двигаться или вступите в бой, то новый образ исчезнет."*/ 
