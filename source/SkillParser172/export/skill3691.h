        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
				...
				static const float LEVEL_5_7 = 1.10;
				static const float LEVEL_8_9 = 1.40;
				static const float LEVEL_10_10 = 1.7;
