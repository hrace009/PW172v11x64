...
{ 
    ...
    { 
        static float aarray[10] = { 402,490,577,665,752,840,927,1015,1102,1190 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
