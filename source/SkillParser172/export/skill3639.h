...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            {
				/*
				^00ffff1-4 ���.: �է�ҧѧӧݧ�֧��� ^ffffff180%%^00ffff ����ߧ� ����اڧ� �� �ӧڧէ� ����ߧ� ��� ���ڧ�ڧ� �ӧ�է�
				^00ffff5-7 ���.: �է�ҧѧӧݧ�֧��� ^ffffff270%%^00ffff ����ߧ� ����اڧ� �� �ӧڧէ� ����ߧ� ��� ���ڧ�ڧ� �ӧ�է�
				^00ffff8-9 ���.: �է�ҧѧӧݧ�֧��� ^ffffff360%%^00ffff ����ߧ� ����اڧ� �� �ӧڧէ� ����ߧ� ��� ���ڧ�ڧ� �ӧ�է�
				^00ffff 10 ���.: �է�ҧѧӧݧ�֧��� ^ffffff450%%^00ffff ����ߧ� ����اڧ� �� �ӧڧէ� ����ߧ� ��� ���ڧ�ڧ� �ӧ�է�
				*/
                skill->GetPlayer ()->SetDecmp (544);
                skill->SetPlus (9538);
				static const float LEVEL_1_4 = 1.8;
				static const float LEVEL_5_7 = 2.7;
				static const float LEVEL_8_9 = 3.6;
				static const float LEVEL_10_10 = 4.5;
                ...
                skill->SetRatio (2.3 + ( aarray[skill->GetLevel () - 1] ));
