...
{ 
    ...
    { 
        static float aarray[10] = { 1404,1404,1404,1404,1404,1404,1404,1404,1404,1404 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
