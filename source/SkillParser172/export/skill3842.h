        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            {static const float LEVEL_1_4 = 0.20;
				...
				skill->GetPlayer ()->SetDecmp (108); // забирает ману
                skill->SetPlus (3836); // статический урон
                skill->SetRatio (0.5 + aarray[skill->GetLevel () - 1]);// урон от оружия
