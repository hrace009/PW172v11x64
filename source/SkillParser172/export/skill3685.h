...
/* 
36850  "Великий зыбучий песок"36851  "^ff5c00Великий зыбучий песок^ffcb4aДальность: ^96f5ff%d^ffffff ^ffcb4aм^ffcb4aМаг. энергия: ^96f5ff%d^ffffff^ffcb4aПодготовка: ^ffffff1,8 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff1 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff10 ^ffcb4aсек.^ffcb4aПолучение ци: ^ffffff0,2^ffcb4aОграничение по оружию: ^ffffffмагическое оружие, без оружия^ffcb4aХарактеристика: ^ff5c00Мудрость^ffcb4aСтатус: ^ffffffАсураМаг зачаровывает землю под ногами противника и превращает ее в зыбучий песок.Наносит базовый магический урон, плюс ^96f5ff200%%^ffffff урона оружия, плюс ^96f5ff6560^ffffff ед. урона стихией земли.На ^96f5ff9^ffffff сек. снижает меткость противника на ^96f5ff50%%^ffffff, наносит еще ^96f5ff600%%^ffffff урона оружия плюс ^96f5ff7021^ffffff ед. урона стихией земли.С вероятностью ^96f5ff33%%^ffffff обездвиживает противника на ^96f5ff3^ffffff сек.^ffcb4aЭффект золотой руны:@1^ffcb4a1-4 ур.: добавляется ^96f5ff40%%^ffcb4a урона оружия и ^96f5ff936^ffcb4a ед. урона стихией земли^ffcb4a5-7 ур.: добавляется ^96f5ff60%%^ffcb4a урона оружия и ^96f5ff1404^ffcb4a ед. урона стихией земли^ffcb4a8-9 ур.: добавляется ^96f5ff80%%^ffcb4a урона оружия и ^96f5ff1872^ffcb4a ед. урона стихией земли^ffcb4a 10 ур.: добавляется ^96f5ff100%%^ffcb4a урона оружия и ^96f5ff2340^ffcb4a ед. урона стихией земли@1@2^ffcb4aДобавляется ^96f5ff%d%%^ffcb4a урона оружия и ^96f5ff%d^ffcb4a ед. урона стихией земли.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                static const float LEVEL_1_4 = 0.40;
				static const float LEVEL_5_7 = 0.60;
				static const float LEVEL_8_9 = 0.80;
				...
				skill->GetPlayer ()->SetDecmp (212); // забирает ману
                skill->SetPlus (7620); // статический урон
                skill->SetRatio (2.2 + aarray[skill->GetLevel () - 1]); // урон от оружия
                skill->SetEarthdamage (skill->GetMagicattack ()); // вставляется урон от земли
