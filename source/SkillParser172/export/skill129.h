...
{ 
    ...
    { 
        static float aarray[10] = { 174,204,234,264,294,324,354,384,414,444 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
