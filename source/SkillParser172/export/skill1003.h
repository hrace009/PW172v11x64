...
/* 
10030  "Туман"10031  "^ffffffТуман Уровень %d^ffcb4aДальность: ^ffffff25 м^ffcb4aЗатраты энергии: ^96f5ff35^ffffff^ffcb4aЗатраты физической силы: ^96f5ff%d^ffffff^ffcb4aПрименение: ^ffffffмгновенное^ffcb4aПерезарядка: ^ffffff1^ffcb4a сек.^ffcb4aОграничения: ^ffffffнетНа 4 секунды создает вокруг цели туман, уменьшая ее меткость на %d%%.Снижает ловкость цели на 5 секунд, максимум - на 4 очка.^72fe00Влияние ловкости: каждые 20 очков увеличивают время действия на 1 секунду.^72fe00Влияние ловкости: каждые 50 очков снижают ловкость противника на 1 очко.^ff0000Используется только в воздухе."*/ 
