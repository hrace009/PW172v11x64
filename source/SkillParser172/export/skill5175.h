...
/* 
51750  "Ð­Ñ„Ñ„ÐµÐºÑ‚ ÑƒÐ¼ÐµÐ½Ð¸Ñ 'ÐŸÑ€ÐµÐ³Ñ€Ð°Ð´Ð° Ð¸Ð· Ð¿ÐµÑ€ÑŒÐµÐ²' (Ð±ÐµÑÑÐ¼ÐµÑ€Ñ‚Ð½Ñ‹Ðµ Ð¸ Ð´ÐµÐ¼Ð¾Ð½Ñ‹)"51751  ""*/ 
...
{ 
    ...
    { 
        cls                 = 13; 
#ifdef _SKILL_CLIENT 
        name                = L"ÏÉÄ§Óð¶ÜÐý¼¼ÄÜÐ§¹û"; 
        nativename          = "ÏÉÄ§Óð¶ÜÐý¼¼ÄÜÐ§¹û"; 
        icon                = ""; 
#endif 
        max_level           = 10; 
        type                = 3; 
