...
/* 
50900  "Владение энергией щита"50901  "^ffffffВладение энергией щита Уровень %d^ffcb4aПассивный навык^ffcb4aСтатус: ^ffffffЛюбопытныйВолшебный щит поглощает сияние солнца и луны и создает из них собственную энергию,которая позволяет использовать особо сильные умения. Лимит энергии щита: ^96f5ff%d^ffffff ед.Каждую секунду восстанавливается ^96f5ff%.1f^ffffff ед. энергии щита."*/ 
