...
/* 
15720  "Музыка мечей"15721  "Музыка мечей: Во время атаки запечатывает цель, вместе с тем уменьшая скорость передвиженияи увеличивая показатель наносимого урона. Продолжительность 5 сек. (недоступно)"*/ 
