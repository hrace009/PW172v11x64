...
/* 
52100  "Великая карающая длань"52101  "^ff5c00Великая карающая длань^ffcb4aДальность: ^ffffffближний бой^ffcb4aМаг. энергия: ^96f5ff160,2^ffffff^ffcb4aПодготовка: ^ffffff0,1 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff0,9 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff8,0 ^ffcb4aсек.^ffcb4aПолучение ци: ^ffffff0,2^ffcb4aОграничение по оружию: ^ffffffмеч и щит^ffcb4aХарактеристика: ^ff5c00Храбрость^ffcb4aСтатус: ^ffffffАсураЗа два взмаха мечом противнику наносится базовый физический урон,плюс ^96f5ff300%%^ffffff урона оружия, плюс ^96f5ff8478^ffffff ед. физического урона.При критическом ударе во время первого взмаха всегда увеличиваетполучаемый целью урон на ^96f5ff10%%^ffffff на ^96f5ff5^ffffff сек. При втором взмахес вероятностью ^96f5ff25%%^ffffff восстанавливает здоровье в размере ^96f5ff10%%^ffffffот нанесенного урона.^00ffffЭффект сапфировой руны:@1Если первый взмах оказался критической атакой, получаемый целью урон увеличивается.^00ffff1-4 ур.: цель получает на ^ffffff15%%^00ffff больше урона^00ffff5-7 ур.: цель получает на ^ffffff20%%^00ffff больше урона^00ffff8-9 ур.: цель получает на ^ffffff25%%^00ffff больше урона ^00ffff10 ур.: цель получает на ^ffffff30%%^00ffff больше урона@1@2^00ffffЕсли первый взмах оказался критической атакой, получаемый целью уронувеличивается на ^ffffff%d%%^00ffff.@2	"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
		...
		bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (skill->GetDamage () * 0.);
