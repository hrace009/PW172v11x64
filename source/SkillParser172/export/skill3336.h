...
/* 
33360  "Массовая атака Драконьей кисти"33361  "level = 1, псевдо-массовая атака, только световой эффект, без уронаlevel = 2, истинная массовая атака урон = (0,05 + 0,05 * ( level - 1 ) ) * player.maxhp ;"*/ 
