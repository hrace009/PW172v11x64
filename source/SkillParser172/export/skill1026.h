...
/* 
10260  "Тайная молитва"10261  "^ffffffТайная молитва Уровень %d^ffcb4aЗатраты энергии: ^96f5ff80^ffffff^ffcb4aЗатраты физической силы: ^96f5ff500^ffffff^ffcb4aПрименение: ^ffffffмгновенное^ffcb4aПерезарядка: ^ffffff30^ffcb4a сек.^ffcb4aОграничения: ^ffffffнетС вероятностью %d%% снимает с вас эффект молчания.^ffa083Влияние силы: каждые 2 очка повышают вероятность успеха на 1%%."*/ 
