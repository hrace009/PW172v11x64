...
/* 
28680  "Ð­Ñ„Ñ„ÐµÐºÑ‚Ñ‹ Ð½Ð°Ð²Ñ‹ÐºÐ° 'Ð¡Ð²ÐµÑ‚Ð»Ð¾Ðµ Ð½Ð°ÑÐ»ÐµÐ´Ð¸Ðµ' (Ð¾Ñ‚Ð¼ÐµÐ½ÐµÐ½Ð¾)"28681  "Ð­Ñ„Ñ„ÐµÐºÑ‚Ñ‹ Ð½Ð°Ð²Ñ‹ÐºÐ° 2867"*/ 
...
{ 
    ...
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"´«³ÐÖ®¹â¼¼ÄÜÐ§¹û£¨·ÏÆú£©"; 
        nativename          = "´«³ÐÖ®¹â¼¼ÄÜÐ§¹û£¨·ÏÆú£©"; 
        icon                = "ÎÞÊ½.dds"; 
#endif 
        max_level           = 10; 
        type                = 2; 
