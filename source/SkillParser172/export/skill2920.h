...
/* 
29200  "Проклятие русалки"29201  "^ffff00Проклятие русалки ^ffffffУровень %d^ffcb4aПассивный навык^ffcb4aСтатус: ^ffffffБлагочестивый^ffffffПри атаке накладывается эффект Проклятия русалки, который увеличиваетвремя перезарядки защитных амулетов и идолов врага на ^96f5ff%d^ffffff сек."*/ 
