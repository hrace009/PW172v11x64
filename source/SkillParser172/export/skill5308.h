...
/* 
53080  "Безудержная свобода"53081  "^ff0000Безудержная свобода %d ур.^ffffffДает иммунитет к эффектам, ограничивающим передвижение, на 5 сек.Перезарядка: ^96f5ff%d^ffffff мин."*/ 
