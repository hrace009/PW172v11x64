...
/* 
20830  "Огненная купель"20831  "^ffffffОгненная купель^ffcb4aПодготовка: ^ffffff0.4^ffcb4a сек.^ffcb4aПрименение: ^ffffff0.6^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff90^ffcb4a сек.^ffffffВосстанавливает 70%% здоровья, на 6 сек. защита увеличивается на 200 ед.^a6caf0Специальное умение кристалла кармы."*/ 
