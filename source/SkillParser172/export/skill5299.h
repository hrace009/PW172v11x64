...
/* 
52990  "Несгибаемая воля"52991  "^ff0000Несгибаемая воля %d ур.^ffffffПри получении урона, превышающего 10%% от вашего максимальногозапаса здоровья, поглощает 90%% урона от двух последующих атак.Перезарядка: ^96f5ff%d^ffffff мин. Пассивный навык."*/ 
