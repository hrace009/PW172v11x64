...
/* 
46240  "Аура паркура Лито"46241  "Умение 4624Область аура = 0,1*localvar2Заполнить ID умения в [localvar1]localvar1==4625{level==1 отталкивание;level==2, заморозка;level==3, быстрое изменение 0,01*local0;level==4, вертикальный взлет;level==5, притягивание;level==6, опьянение (не действует);}localvar1==4627 {черный экран (не действует);}localvar1==4631{level==1, телепорт в координаты 1;level==2, телепорт в координаты 2;level==3, телепорт в координаты 3;}"*/ 
