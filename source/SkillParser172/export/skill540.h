...
/* 
5400  "Светлая техника боя с молотом"5401  "^8080ffСветлая техника боя с молотом^ffcb4aПассивный навык^ffcb4aСтатус: ^ffffffБезупречный^ffffffУрон, наносимый топорами и молотами, увеличивается на ^96f5ff%d%%^ffffff.^f7dfa5Дополнительный урон от оружия повышается до ^96f5ff100%%^f7dfa5."*/ 
