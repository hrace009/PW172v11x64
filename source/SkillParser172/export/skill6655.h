...
/* 
66550  "Ð£Ð¼ÐµÐ½Ð¸Ðµ ÑƒÑ€Ð¾Ð½Ð° Ð—Ð°Ñ‰Ð¸Ñ‚Ð½Ð¾Ð¹ Ð±Ð°ÑˆÐ½Ð¸ Ð½Ð¾Ð²Ñ‹Ñ… Ð³Ð¾Ñ€Ð¾Ð´ÑÐºÐ¸Ñ… ÑÑ€Ð°Ð¶ÐµÐ½Ð¸Ð¹"66551  "% ÑƒÑ€Ð¾Ð½Ð° Ð¾Ñ‚ Ð½ÐµÐ²Ð¸Ð´Ð¸Ð¼Ð¾Ð¹ Ð·Ð°Ñ‰Ð¸Ñ‚Ñ‹"*/ 
...
{ 
    ...
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÐÂ³ÇÕ½·ÀÓùËþÉËº¦¼¼ÄÜ"; 
        nativename          = "ÐÂ³ÇÕ½·ÀÓùËþÉËº¦¼¼ÄÜ"; 
        icon                = "ÁÒÑæÖ®Ê¸1.dds"; 
#endif 
        max_level           = 9999; 
        type                = 3; 
