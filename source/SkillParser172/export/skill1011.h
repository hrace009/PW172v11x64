...
/* 
10110  "Волна яда"10111  "^ffffffВолна яда Уровень %d^ffcb4aДальность: ^ffffff15 м^ffcb4aЗатраты энергии: ^96f5ff%d^ffffff^ffcb4aЗатраты физической силы: ^96f5ff%d^ffffff^ffcb4aПрименение: ^ffffffмгновенное^ffcb4aПерезарядка: ^ffffff60^ffcb4a сек.^ffcb4aОграничения: ^ffffffнетСоздает ядовитую волну, поражающую всех противников в радиусе 15 м.Яд уменьшает максимальный запас ЖС на %d%% на 10 сек.С вероятностью %d%% волна прерывает подготовку заклинаний.^72fe00Влияние ловкости: каждые 20 очков увеличивают время действия эффекта на 1 сек.^ff0000Используется только в воде."*/ 
