...
/* 
37850  "Великие семь убийств"37851  "^ff5c00Великие семь убийств^ffcb4aДальность: ^ffffff4,5^ffffff ^ffcb4aм^ffcb4aМаг. энергия: ^96f5ff130^ffffff^ffcb4aПодготовка: ^ffffff0,1 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff2,5 ^ffcb4aсек.^ffcb4aПерезарядка: ^ff5c004,0 ^ffcb4aсек.^ffcb4aПолучение ци: ^ffffff0,3^ffcb4aОграничение по оружию: ^ffffffкинжалы^ffcb4aХарактеристика: ^ff5c00Мощь^ffcb4aСтатус: ^ffffffАсураСекретная техника Лиги семи убийств.Наносит ^96f5ff320%%^ffffff базового физического урона.^a6caf0Дает ^ff5c003^a6caf0 очка комбо.^ff0000Эффект рубиновой руны:@1^ff00001-4 ур.: добавляет урон в размере ^96f5ff20%%^ff0000 базовой силы физ. атаки^ff00005-7 ур.: добавляет урон в размере ^96f5ff40%%^ff0000 базовой силы физ. атаки^ff00008-9 ур.: добавляет урон в размере ^96f5ff60%%^ff0000 базовой силы физ. атаки^ff0000 10 ур.: добавляет урон в размере ^96f5ff80%%^ff0000 базовой силы физ. атаки@1@2Добавляет урон в размере ^96f5ff%d%%^ff0000 базовой силы физ. атаки.@2"*/ 
...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                float glyph = get_glyph((skill->GetLevel () - 1), 20, 40, 60, 80);
