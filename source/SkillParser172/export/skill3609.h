...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
				/*
				^00ffff1-4 ���.: �ӧ�֧ާ� ���էԧ���ӧܧ� ���ܧ�ѧ�ѧ֧��� �է� ^ffffff1,6^00ffff ��֧�.
				^00ffff5-7 ���.: �ӧ�֧ާ� ���էԧ���ӧܧ� ���ܧ�ѧ�ѧ֧��� �է� ^ffffff1,2^00ffff ��֧�.
				^00ffff8-9 ���.: �ӧ�֧ާ� ���էԧ���ӧܧ� ���ܧ�ѧ�ѧ֧��� �է� ^ffffff0,8^00ffff ��֧�.
				^00ffff 10 ���.: �ӧ�֧ާ� ���էԧ���ӧܧ� ���ܧ�ѧ�ѧ֧��� �է� ^ffffff0,4^00ffff ��֧�.
				*/
				static const int LEVEL_1_4 = 1600;
				static const int LEVEL_5_7 = 1200;
				static const int LEVEL_8_9 = 800;
