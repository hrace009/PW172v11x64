...
#define get_glyph(level, l1_4, l5_7, l8_9, lmax) level >= 1 && level <= 4 ? l1_4 : level >= 5 && level <= 7 ? l5_7 : level >= 8 && level <= 9 ? l8_9 : lmax; 
    ...
    { 
        ...
        {
			/*
			^ffeaab1-4 ур.: основной эффект длится ^96f5ff2^ffeaab сек.
			^ffeaab5-7 ур.: основной эффект длится ^96f5ff3^ffeaab сек.
			^ffeaab8-9 ур.: основной эффект длится ^96f5ff4^ffeaab сек.
			^ffeaab10 ур.: основной эффект длится ^96f5ff5^ffeaab сек.
			*/			
