...
/* 
26050  "Иллюзии - Колдовство"26051  "^ffffffИллюзии - Колдовство^ffcb4aДальность: ^ffffff27 ^ffcb4aм^ffcb4aПодготовка: ^ffffff0,6 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff1,3 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff1,0 ^ffcb4aсек.^ffcb4aОграничение по оружию: ^ffffffсабляПризрак копирует навык у друида, превращая противника взверюшку, которая может только перемещаться. Длительность эффекта - ^96f5ff4^ffffff сек.^a6caf0Этот эффект действует только на персонажей.^a6caf0Дополнительная стоимость: ^ffffff0,5^a6caf0 ци"*/ 
