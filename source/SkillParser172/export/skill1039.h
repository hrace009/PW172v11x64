...
/* 
10390  "Чистая сфера"10391  "^ffffffЧистая сфера Уровень %d^ffcb4aЗатраты энергии: ^96f5ff135^ffffff^ffcb4aЗатраты физической силы: ^96f5ff999^ffffff^ffcb4aПрименение: ^ffffffмгновенное^ffcb4aПерезарядка: ^ffffff180^ffcb4a сек.^ffcb4aОграничения: ^ffffffнетОкружает вас защитной сферой, которая блокирует весь урон. Время действия - %.1f сек.После окончания действия сферы придает невосприимчивость к обездвиживанию на 2 сек."*/ 
