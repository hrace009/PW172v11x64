...
/* 
18430  "Спокойствие"18431  "^ffff00Спокойствие^ffcb4aМаг. энергия: ^96f5ff%d^ffffff^ffcb4aПодготовка: ^ffffff0,1^ffcb4a сек.^ffcb4aПрименение: ^ffffff0,6^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff120,0^ffcb4a сек.^ffcb4aОграничение по оружию: ^ffffffоружие дальнего боя^ffcb4aСтатус: ^ffffffБлагочестивыйЛучник входит в состояние невидимости. Уровень скрытности повышается на ^96f5ff31^ffffff,а скорость передвижения замедляется до ^96f5ff0,1^ffffff м/c. Расходует ^96f5ff50^ffffff ед. МЭ в секунду.Применение навыков 'Огненные стрелы' и 'Вспышка' выводит из состояния невидимости."*/ 
...
{ 
    ...
    { 
        static float aarray[10] = { 121,121,121,121,121,121,121,121,121,121 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
