...
{ 
    ...
    { 
        static float aarray[10] = { 114,123,132,141,150,159,168,177,186,195 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
