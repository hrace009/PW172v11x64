...
/* 
21270  "Душа"21271  "^ffffffЭнергия духа Ур.: %d^ffcb4aПодготовка: ^ffffff0.1^ffcb4a сек.^ffcb4aПрименение: ^ffffff0.1^ffcb4a сек.^ffcb4aПерезарядка: ^ffffff30^ffcb4a сек.^ffffffПоказатели атаки и защиты увеличиваются на ^96f5ff%d^ffffff ед., Получаемый урон от игроковуменьшается на ^96f5ff55%%^ffffff."*/ 
