...
/* 
60990  "Откровение о дружбе"60991  "^ffff00Действует только на ^ff00ffАиду^ffff00.^ffff00Наносит урон, равный 10%% от ее максимального запаса здоровья.^ff00ffАида^ffff00 сильна, но Борд и Эрин помогут вам."*/ 
