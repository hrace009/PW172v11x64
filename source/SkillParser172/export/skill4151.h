        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus ((skill->GetCharging () / 1700) * 7634.0);
                skill->SetRatio ((skill->GetCharging () / 1700) * 3.1);
