...
bool BlessMe (Skill * skill) const
        {     
			skill->GetVictim ()->SetProbability (1.0 * (17 * skill->GetPlayer()->GetChargeMerc()));
			...
			// ��ا֧�� �ӧ�� �ܧ�ާҧ���ܧ�
			skill->GetPlayer ()->SpendChargeMerc(skill->GetPlayer()->GetChargeMerc());
            return true;
        }
#endif 
#ifdef _SKILL_SERVER 
