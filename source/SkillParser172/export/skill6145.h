...
/* 
61450  "Ð­Ñ„Ñ„ÐµÐºÑ‚ ÑƒÐ¼ÐµÐ½Ð¸Ñ Ñ†ÐµÐ½Ñ‚Ñ€Ð°Ð»ÑŒÐ½Ð¾Ð³Ð¾ ÑÐµÐºÑ‚Ð¾Ñ€Ð° Ð³Ð¾Ð´Ð¾Ð²Ñ‰Ð¸Ð½Ñ‹"61451  "ÐÐºÑ‚Ð¸Ð²Ð¸Ñ€ÑƒÐµÑ‚ ÑÐµÐºÑ‚Ð¾Ñ€ Ñ‚ÐµÐ»ÐµÐ¿Ð¾Ñ€Ñ‚Ð°"*/ 
...
{ 
    ...
    { 
        cls                 = 127; 
#ifdef _SKILL_CLIENT 
        name                = L"ÖÜÄêÇìÖÐÐÄ»·ÉÈÐÎ¼¼ÄÜÐ§¹û"; 
        nativename          = "ÖÜÄêÇìÖÐÐÄ»·ÉÈÐÎ¼¼ÄÜÐ§¹û"; 
        icon                = ""; 
#endif 
        max_level           = 9999; 
        type                = 12; 
