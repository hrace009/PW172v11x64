...
/* 
64710  "Стальное тело"64711  "^ffffffСтальное тело Уровень %d^ffcb4aПассивный навык^ffcb4aСтатус: ^ffffffЛюбопытныйВ образе обезьяны весь получаемый прямой урон уменьшается на величину, равную^96f5ff%.1f%%^ffffff от максимального запаса здоровья плюс ^96f5ff100^ffffff ед., но не более чем на ^96f5ff3000^ffffff ед."*/ 
