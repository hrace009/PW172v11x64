    ...
    public: 
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (0.2 * (79.2 + (7.2 * skill->GetLevel () - 7.2)));
