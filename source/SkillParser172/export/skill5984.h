...
/* 
59840  "Владыка севера [иммунитет к урону]"59841  "^ff0000Пустота: Уклонение^ffcb4aПассивное умение^ffffffПри входящей атаке с шансом ^96f5ff20%%^ffffff будет проигнорирован эффект одного удара."*/ 
