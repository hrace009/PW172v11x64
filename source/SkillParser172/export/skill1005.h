...
/* 
10050  "Танец листвы"10051  "^ffffffТанец листвы Уровень %d^ffcb4aДальность: ^ffffff10 м^ffcb4aЗатраты энергии: ^96f5ff40^ffffff^ffcb4aЗатраты физической силы: ^96f5ff500^ffffff^ffcb4aПрименение: ^ffffffмгновенное^ffcb4aПерезарядка: ^ffffff1^ffcb4a сек.^ffcb4aОграничения: ^ffffffнетУвеличивает шанс нанесения критического удара на 2%% на %d сек.Не складывается с другими подобными эффектами.^ffa083Влияние силы: каждое очко увеличивает время действия на 1 сек."*/ 
...
{ 
    ...
    { 
        static float aarray[10] = { 40,40,40,40,40,40,40,40,40,40 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
