...
/* 
23620  "Огненный щит"23621  "^ffffffОгненный щит Уровень: 2^ffcb4aПодготовка: ^ffffff0,5 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff0,5 ^ffcb4aсек.^ffcb4aПерезарядка: ^ffffff30 ^ffcb4aсек.^ffffffСила огня защищает персонажа, на короткое время позволяя ему уклониться от большинства атак и эффектов."*/ 
