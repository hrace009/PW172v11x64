...
/* 
63100  "Безграничная защита"63101  "^ffff00Безграничная защита^ffffff Уровень %d^ffcb4aПассивный навык^ffcb4aСтатус: ^ffffffМудрец^ffffffПовышает максимальное значение снижения уроназа счет физической и магической защиты до ^96f5ff%.1f%%^ffffff."*/ 
...
{ 
    ...
    { 
        static int aarray[10] = { 68977,68977,68977,68977,68977,68977,68977,68977,68977,68977 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
    ...
    { 
        static int aarray[10] = { 71,73,75,77,79,79,79,79,79,79 }; 
        return aarray[skill->GetLevel () - 1]; 
    } 
