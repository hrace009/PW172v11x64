...
/* 
26040  "Иллюзии - Дух мести: Потрясение"26041  "^ffffffИллюзии - Дух мести: потрясение^ffcb4aПодготовка: ^ffffff0,5 ^ffcb4aсек.^ffcb4aПрименение: ^ffffff0,8 ^ffcb4aсек.^ffcb4aОграничение по оружию: ^ffffffсабляПризрак копирует навык шамана, накладывая эффект на себя.При атаке на вас, на атакующего накладывается обморок.Чем выше сила духа бойца, тем дольше у врага длится обморок.Эффект потрясения вызывает у врага обморок минимум на ^96f5ff1^ffffff сек., с каждыми ^96f5ff9000^ffffff оч. силы духадлительность обморока увеличивается на ^96f5ff1^ffffff сек. При удачной активации эффектапотрясения расходуется собственная мана.После успешной активации эффект перестает действовать.Максимальная длительность эффекта потрясения - ^96f5ff30^ffffff сек."*/ 
